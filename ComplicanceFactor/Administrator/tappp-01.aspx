<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="tappp-01.aspx.cs" Inherits="ComplicanceFactor.Administrator.tappp_01" %>
    ...
    <div class="div_controls font_1">
        <table>
            <tr>
                ...
                <td align="right">
                    <input type="button" class="rstpwd cursor_hand" value='<asp:Literal ID="Literal1" runat="server" Text="<%$ LabelResourceExpression: app_reset_your_password_button_text %>" />' />
                </td>
            </tr>
        </table>
        <div class="clear">
            ...
            <table cellspacing="0" cellpadding="0" class="gridview_long_no_border">
                <thead>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlNumberOfRecourdsCourse" runat="server">
                                <asp:ListItem Value="5">5</asp:ListItem>
                                <asp:ListItem Value="10">10</asp:ListItem>
                                <asp:ListItem Value="20">20</asp:ListItem>
                                <asp:ListItem Value="30">30</asp:ListItem>
