...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="content_area">
            <%= LocalResources.GetText("app_welcome_content_manager_profile_text")%>
            <br />
            <br />
            <br />
        </div>
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td align="right">
                        <input type="button" class="rstpwd" value='<asp:Literal ID="ltlViewDetails" runat="server" Text="<%$ LabelResourceExpression: app_reset_your_password_button_text %>" />' />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="div_controls font_1">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <%=LocalResources.GetLabel("app_user_state_province_text")%>:
                    </td>
                    <td>
                        <asp:TextBox ID="txtStateprovince" CssClass="textbox_manage_user" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <%=LocalResources.GetLabel("app_user_zip_postal_code_text")%>:
                    </td>
                    <td>
        ...
        <br />
        <div class="content_area">
            <%= LocalResources.GetText("app_welcome_content_footer_manager_profile_text")%>
        </div>
        <br />
        <br />
    </div>
