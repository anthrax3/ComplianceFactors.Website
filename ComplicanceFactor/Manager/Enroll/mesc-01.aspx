        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_800 tablesorter"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_employee_first_name_text %>" DataField='u_last_name'
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnAssignOnly" OnClientClick="return validateCheckBoxes();" runat="server"
                                ValidationGroup="mesc" Text="<%$ LabelResourceExpression: app_assign_only_button_text %>"
                                OnClick="btnAssignOnly_Click" />
                            <asp:Button ID="btnRequestAssign" OnClientClick="return validateCheckBoxes();" runat="server"
                                ValidationGroup="mesc" Text="<%$ LabelResourceExpression: app_request_assignment_button_text %>"
                                Style="display: none;" OnClick="btnRequestAssignment_Click" />
                        </td>
                        <td>
                            <asp:Button ID="btnConfirmEnrollment" OnClientClick="return validateCheckBoxes();"
                                runat="server" ValidationGroup="mesc" Text="<%$ LabelResourceExpression: app_confirm_enrollments_button_text %>"
                                OnClick="btnConfirmEnrollment_Click" />
                            <asp:Button ID="btnRequestEnrollment" OnClientClick="return validateCheckBoxes();"
                                ValidationGroup="mesc" runat="server" Text="<%$ LabelResourceExpression: app_request_enrollments_button_text %>"
                                OnClick="btnRequestEnrollment_Click" Style="display: none;" />
                        </td>
                    </tr>
                </table>
                <br />
