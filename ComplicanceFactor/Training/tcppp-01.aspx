<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="tcppp-01.aspx.cs" Inherits="ComplicanceFactor.Training.tcppp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_training_profile_text")%><br />
        <br />
        <br />
    </div>
            ...
            <table cellspacing="0" cellpadding="0" class="gridview_long_no_border">
                <thead>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlNumberOfRecourdsDeliveries" runat="server">
                                <asp:ListItem Value="5">5</asp:ListItem>
                                <asp:ListItem Value="10">10</asp:ListItem>
                                <asp:ListItem Value="20">20</asp:ListItem>
                                <asp:ListItem Value="30">30</asp:ListItem>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlCollapsedDeliveries" DataValueField="id" DataTextField="name"
                                runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_footer_training_profile_text")%>
        <br />
        <br />
    </div>
    </div>
