    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=btnAddCategory.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': 'CategorySearch/sascn-01.aspx?page=saedin&editDocumentId=' + editDocumentId,
                'onComplete': function () {
            ...
            $(".deleteCategory").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saedin-01.aspx/DeleteCategory",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <tr>
                    ...
                    <td class="align_left" colspan="4">
                        ...
                        <asp:Button ID="btnEdit" runat="server" Text="<%$ LabelResourceExpression: app_edit_button_text %>"
                            CssClass="style1" OnClick="btnEdit_Click" />
                ...
                <asp:GridView ID="gvCategory" RowStyle-CssClass="record" GridLines="None" CssClass="gridview_normal_800"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="gridview_row_width_1" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("c_document_system_id_pk") %>' value='<asp:Literal ID="Literal1" runat="server" Text="delete" />'
    ...
    <asp:ModalPopupExtender ID="mpeAddAttachment" TargetControlID="btnAttachment" BackgroundCssClass="transparent_class"
        PopupControlID="pnlAddAttachment" OkControlID="imgClose" DropShadow="false" PopupDragHandleControlID="pnlUploadFileHeading"
        CancelControlID="btnCancel" OnCancelScript="cleartext()" OnOkScript="cleartext()"
        runat="server">
    ...
    <div class="font_normal">
        <asp:Panel ID="pnlCreateNewVersion" CssClass="modalPopup_width_620 modal_popup_background"
            Style="display: none; padding-left: 0px; padding-right: 0px;" runat="server">
            ...
            <asp:RequiredFieldValidator ID="rfvNewVersionNo" Style="display: none" ControlToValidate="txtNewVersionNumber"
                runat="server" ValidationGroup="saedin" ErrorMessage="<%$ TextResourceExpression: app_version_number_error_empty %>"></asp:RequiredFieldValidator>
            ...
            <div>
                <table cellpadding="0" cellspacing="0" class="button_600">
                    <tr>
                        <td align="left">
                            <asp:Button ID="btnSaveNewVersion" CssClass="cursor_hand" runat="server" ValidationGroup="saedin"
                                Text="<%$ LabelResourceExpression: app_create_new_version_button_text %>" OnClick="btnSaveNewVersion_Click" />
                        </td>
                        <td align="left">
