<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="p-secp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Curriculum.CurriculumPath.p_secp_01"
        ...
        $(document).ready(function () {
            $(".newcourse").click(function () {
                ...
                $.fancybox({
                    ...
                    'href': '../CourseSearch/p-spcs-01.aspx?course=true&mode=edit&page=p-secp-01&sec=' + record_id + '&editcurriculumId=' + editcurriculumId + '&editCurriculumpathId=' + editCurriculumpathId,
                    'onComplete': function () {
            ...
            $(".couserequired").change(function () {
                ...
                $.ajax({
                    ...
                    url: "p-secp-01.aspx/CourseNotRequired",
                    ...
                    success: function () {
                        ...
                        window.location.replace("../Path/p-secp-01.aspx");
            ...
            $(".cousenotrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secp-01.aspx/CourseRequired",
            ...
            $(".sectionrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secp-01.aspx/SectionNotRequired",
            ...
            $(".sectionnotrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secp-01.aspx/SectionRequired",
   ...
   <div id="content">
        ...
        <div>
            ...
            <asp:DataList ID="dlSection" runat="server" ShowFooter="true" CellPadding="0" CssClass="grid_870"
                CellSpacing="0" OnItemDataBound="dlSection_ItemDataBound" DataKeyField="c_curricula_path_section_id_pk">
                <ItemTemplate>
                    ...
                    <asp:GridView ID="gvCourse" CellPadding="0" CellSpacing="0" RowStyle-CssClass="record MoveableRow"
                        ...
                        DataKeyNames="c_curricula_path_course_id_fk,c_curricula_path_course_seq_number,c_curricula_path_course_system_id_pk">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
