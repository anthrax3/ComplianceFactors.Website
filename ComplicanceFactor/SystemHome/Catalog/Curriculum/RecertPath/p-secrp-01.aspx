<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="p-secrp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Curriculum.RecertPath.p_secrp_01" %>
        ...
        $(document).ready(function () {
            $(".newcourse").click(function () {
                ...
                $.fancybox({
                    ...
                    'href': '../CourseSearch/p-spcs-01.aspx?course=true&mode=edit&page=p-secrp-01&sec=' + record_id + '&editcurriculumId=' + editcurriculumId + '&editCurriculumpathId=' + editCurriculumpathId,
                    'onComplete': function () {
            ...
            $(".couserequired").change(function () {
                ...
                $.ajax({
                    ...
                    url: "p-secrp-01.aspx/CourseNotRequired",
                    ...
                    success: function () {
                        ...
                        window.location.replace("../RecertPath/p-secrp-01.aspx");
            ...
            $(".cousenotrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secrp-01.aspx/CourseRequired",
                    ...
                    success: function () {
                        ...
                        //alert('h');
                        //window.location("../SystemHome/Catalog/Path/p-secp-01.aspx")
                        window.location.replace("../RecertPath/p-secrp-01.aspx");

                        //?page=saec&editCurriculumId=' + editcurriculumId
            ...
            $(".sectionrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secrp-01.aspx/SectionNotRequired",
            ...
            $(".sectionnotrequired").change(function () {
                ...
                $.ajax({
                    ...
                    //sasw-01.aspx is the page name and delete locale is the server side method to delete records in sacatvml-01.aspx.cs
                    url: "p-secrp-01.aspx/SectionRequired",
    ...
    <div id="content">
        ...
        <div>
            ...
            <asp:DataList ID="dlSection" runat="server" ShowFooter="true" CellPadding="0" CssClass="grid_870"
                CellSpacing="0" OnItemDataBound="dlSection_ItemDataBound" DataKeyField="c_curricula_recert_path_section_id_pk">
                <ItemTemplate>
                    ...
                    <div>
                        ...
                        <table cellpadding="0" cellspacing="0" class="grid_870">
                            <tr>
                                ...
                                <td>
                                    <%=LocalResources.GetLabel("app_completed_text")%>&nbsp;<asp:TextBox ID="txtCourseComplete"
                                        runat="server" CssClass="textbox_50" />
                                    <%=LocalResources.GetLabel("app_out_text")%>&nbsp;<%=LocalResources.GetLabel("app_of_text")%>
                    ...
                    <asp:GridView ID="gvCourse" CellPadding="0" CellSpacing="0" RowStyle-CssClass="record MoveableRow"
                        ...
                        DataKeyNames="c_curricula_recert_path_course_id_fk,c_curricula_recert_path_course_seq_number,c_curricula_recert_path_course_system_id_pk">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <table cellpadding="0" class="record" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnUp" runat="server" Text="<%$ LabelResourceExpression: app_up_button_text%>"
                                                    CommandName="Up" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                                            </td>
                                            <td>
                                                <asp:Button ID="btnDown" runat="server" Text="<%$ LabelResourceExpression: app_down_button_text%>"
                                                    CommandName="Down" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                                            </td>
                                            <td>
                                                <asp:Button ID="btnRemove" OnClientClick="return Removeconfirmation();" runat="server"
                                                    Text="<%$ LabelResourceExpression: app_remove_button_text%>" CommandName="Remove"
                        ...
                        <RowStyle CssClass="record MoveableRow" />
                    </asp:GridView>
                </ItemTemplate>
            </asp:DataList>
            <br />
            ...
            <div class="div_controls font_1">
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="align_left">
                            <asp:Button ID="btnSavePath" runat="server" Text="<%$ LabelResourceExpression: app_save_path_button_text%>"
                                OnClick="btnSavePath_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
