<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samccmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Category.samccmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_categories_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                runat="server" DataKeyNames="s_category_system_id_pk" EmptyDataText="No result found."
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_category_id_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_category_id" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_category_name_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_category_name_us_english" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_parent_category_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="parent_categoryName" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_1"
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnArchive" CommandName="Archive" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'
                                CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_archive_button_text %>"
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_categories_search_text")%>:
            </div>
            <br />
            <div class="div_controls font_1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlParentCategory" CssClass="ddl_user_advanced_search" DataTextField="s_category_name"
                                DataValueField="s_category_system_id_pk" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddCategory" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_category_button_text %>"
