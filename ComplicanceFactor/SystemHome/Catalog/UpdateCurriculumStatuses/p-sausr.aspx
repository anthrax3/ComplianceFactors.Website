                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="align_right">
                            <asp:Button CssClass="cursor_hand" ID="btnCancel" runat="server" Text="<%$ LabelResourceExpression: app_cancel_button_text %>" OnClientClick="javascript:document.forms[0].submit();parent.jQuery.fancybox.close();" />
                        </td>
                    </tr>
                </table>
            </div>
