<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="savloc-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Rooms.Locale.savloc_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var editroomId = $.QueryString("roomid"),
            editroomId = (!editroomId) ? "null" : editroomId; // Passing the value null to string
            ...
            $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'href': '../Locale/saaloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&editRoomId=" + editroomId,
                    'onComplete': function () {
            ...
            <div class="div_padding_40">
                <asp:GridView ID="gvLocale" RowStyle-CssClass="record" CssClass="grid_700" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="width_35">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("s_locale_system_id_pk") %>' value='<asp:Literal ID="Literal1" runat="server" Text="<%$ LabelResourceExpression: app_edit_button_text %>" />'
                                    class="editlocale cursor_hand" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-CssClass="width_35" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("s_locale_system_id_pk").ToString() + "," +  Eval("s_locale_id_fk").ToString() + "," +  Eval("s_locale_text").ToString()%>' value='<asp:Literal ID="Literal2" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
                ...
                <div>
                    <table class="grid_700" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="btnClose" runat="server" Text="<%$ LabelResourceExpression: app_close_window_text %>" OnClientClick="javascript:document.forms[0].submit();parent.jQuery.fancybox.close()" />
                            </td>
                        </tr>
                    </table>
                </div>
