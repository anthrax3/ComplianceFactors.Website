<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samroimp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Rooms.samroimp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            ...
            document.getElementById('<%=ddlRoomType.ClientID %>').selectedIndex = '0';
            document.getElementById('<%=txtFacility.ClientID %>').value = '';
            return false;
        }
    </script>
    <br />
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_rooms_search_results_text")%>: 
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                EmptyDataRowStyle-CssClass="empty_row" PagerSettings-Visible="false" DataKeyNames="c_room_system_id_pk"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_room_id_text %>" HeaderStyle-HorizontalAlign="Center" DataField="c_room_id_pk"
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_room_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField="c_room_name"
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_facility_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField="c_facility_name"
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_room_type_text %>" HeaderStyle-HorizontalAlign="Center" DataField="s_room_type_name_us_english"
                        ItemStyle-HorizontalAlign="Left" />
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_1"
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Button ID="btnArchive" CommandName="Archive" OnClientClick="return confirmStatus();" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_rooms_search_text")%>: 
            </div>
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewFacility" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_room_button_text %>"
                                OnClick="btnAddNewFacility_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                        <td class="btnreset_td">
                            <asp:Button ID="btnReset"  CssClass="cursor_hand" OnClientClick="return resetall();" Text="<%$ LabelResourceExpression: app_reset_button_text %>" runat="server" />
                        </td>
