<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="sarsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Facilities.Room.Resource.sarsr_01" %>
   ...
   <div id="content">
        ...
        <div>
            <div class="div_header_700">
                <%=LocalResources.GetLabel("app_advanced_resource_search_result_text")%>:
            </div>
            <br />
            <div>
        ...
        <div>
            <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
                <div class="div_header_700">
                    <%=LocalResources.GetLabel("app_advanced_resource_search_text")%>:
                </div>
                <br />
