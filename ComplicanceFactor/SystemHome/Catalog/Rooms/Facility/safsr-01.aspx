<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="safsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Rooms.Facility.safsr_01" %>
    ...
    <div id="content">
        ...
        <div class="div_padding_25">
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                runat="server" EmptyDataText="No result found." DataKeyNames="c_facility_system_id_pk"
