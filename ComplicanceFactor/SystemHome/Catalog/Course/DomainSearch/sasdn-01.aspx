<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sasdn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.DomainPopup.sasdn_01" %>
    ...
    <div>
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_popup_1">
                <%=LocalResources.GetLabel("app_domains_search_text")%>:
            </div>
            <br />
