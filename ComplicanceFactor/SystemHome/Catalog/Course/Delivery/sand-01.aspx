...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%=btnOwner.ClientID %>").fancybox({
                ...
                'href': '/SystemHome/sasumsm-01.aspx?deliveryowner=true&page=sand',
                'onComplete': function () {
            ...
            $("#<%=btnCoordinator.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '/SystemHome/sasumsm-01.aspx?deliverycoordiantor=true&page=sand',
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $("#<%=btnOpenSessionWizard.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/Session/sasw-01.aspx?page=sasw',
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $("#<%=btnAddResources.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/ResourseSearch/saress-01.aspx?page=sand',
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $("#<%=btnAddMaterials.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/MaterialSearch/samats-01.aspx?page=sand',
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $(".deleteresource").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "sand-01.aspx/DeleteResource",
            ...
            $(".deletematerial").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        //sasw-01.aspx is the page name and delete instructor is the server side method to delete records in saantc-01.aspx.cs
                        url: "sand-01.aspx/DeleteMaterial",
        ...
        $(document).ready(function () {
            ...
            $(".deletesession").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        //sasw-01.aspx is the page name and delete instructor is the server side method to delete records in saantc-01.aspx.cs
                        url: "sand-01.aspx/DeleteSession",
            ...
            $(".editsession").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': '../Delivery/Session/saes-01.aspx?page=sand&editSession=' + record_id,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#txtCreditHours").keypress(function (e) {

                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#txtCreditUnits").keypress(function (e) {

                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#txtMinEnroll").keypress(function (e) {

                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#txtMaxEnroll").keypress(function (e) {

                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#txtEnrollThreshhold").keypress(function (e) {

                if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
                    return false;
                }
            });
            $("#txtMaxwaitList").keypress(function (e) {
