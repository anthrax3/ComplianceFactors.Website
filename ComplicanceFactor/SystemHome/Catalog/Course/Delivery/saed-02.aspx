<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="saed-02.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.DeliveryPopup.saed_02"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%=btnOpenSessionWizard.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/Session/sasw-01.aspx?mode=addsession&page=sasw&editcourseid=' + editcourseid,
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $("#<%=btnAddResources.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/ResourseSearch/saress-01.aspx?page=saed-02&editdelivery=' + message,
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $("#<%=btnAddMaterials.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Delivery/MaterialSearch/samats-01.aspx?page=saed-02&editdelivery=' + message,
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $(".deleteresource").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saed-02.aspx/DeleteResource",
            ...
            $(".deletematerial").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        //sasw-01.aspx is the page name and delete instructor is the server side method to delete records in saantc-01.aspx.cs
                        url: "saed-02.aspx/DeleteMaterial",
            ...
            $(".deletesession").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        //sasw-01.aspx is the page name and delete instructor is the server side method to delete records in saantc-01.aspx.cs
                        url: "saed-02.aspx/DeleteSession",
...
//            var editcourseid = $.QueryString("editcourseid"),
            ...
            $(".editsession").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': '../Delivery/Session/saes-02.aspx?page=saes-02&editsession=' + record_id + "&editdelivery=" + editdelivery + "&editcourseid=" + editcourseid,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
...
//            var editdeliveryId = $.QueryString("editdelivery"),
            ...
            var editdeliveryId = document.getElementById("<%=hdEditdelivery.ClientID %>").value;
             $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': '../Delivery/Locale/saaloc-01.aspx?mode=edit' + '&localeid=' + localeid + "&localeText=" + localeText + "&editDeliveryId=" + editdeliveryId,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
            ...
            $(".editlocale").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': '../Delivery/Locale/saeloc-01.aspx?mode=edit' + '&localeid=' + localeid + "&localeText=" + localeText + "&id=" + record_id,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlDeliveryType" DataValueField="s_delivery_type_system_id_pk" DataTextField="s_delivery_type_name"
                ...
                <tr>
                    <td colspan="6" class="align_left">
                        ...
                        <asp:DropDownList ID="ddlApprovalRequired" CssClass="textbox_long" DataTextField="s_approval_workflow_name" DataValueField="s_approval_workflow_system_id_pk"
                        runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                            ...
                            <ItemTemplate>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="gridview_row_width_1" align="center">
                                            <input type="button" id='<%# Eval("c_course_resources_id_pk") %>' value='<asp:Literal ID="Literal4" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
                            ...
                            <ItemTemplate>
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="gridview_row_width_1" align="center">
                                            <input type="button" id='<%# Eval("c_course_material_id_pk") %>' value='<asp:Literal ID="Literal6" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
