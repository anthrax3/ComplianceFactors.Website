<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="saes-02.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.DeliveryPopup.saes_02"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var editsession = $.QueryString("editsession"),
            editsession = (!editsession) ? "null" : editsession; // Passing the value null to string
            ...
            $("#<%=btnAddInstructor.ClientID %>").fancybox({
                ...
                'overlayOpacity': 0.7,
                'hideOnOverlayClick': false,
                'href': '../Session/InstructorSearch/sainss-01.aspx?page=saed-02&editsession=' + editsession + "&editdelivery=" + editdelivery,
                'onComplete': function () {
                    $.fancybox.showActivity();
                    $('#fancybox-frame').load(function () {
                        $.fancybox.hideActivity();
            ...
            $(".deleteinstructor").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saes-02.aspx/DeleteInstructor",
