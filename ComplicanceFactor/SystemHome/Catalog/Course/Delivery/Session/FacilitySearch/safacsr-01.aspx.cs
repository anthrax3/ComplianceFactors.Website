...
{
    public partial class safacsr_01 : BasePage
    {
        ...
        private void SearchResult()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ConfigurationWrapper.LogErrors == true)
                {
                    ...
                    {
                        Logger.WriteToErrorLog("safacsr-01.aspx", ex.Message, ex.InnerException.Message);
                    }
                    else
                    {
                        Logger.WriteToErrorLog("safacsr-01.aspx", ex.Message);
                    }
                }
            }
        ...
        protected void gvsearchDetails_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Select"))
            {
                if (!string.IsNullOrEmpty(Request.QueryString["page"]) && Request.QueryString["page"] == "sand" || !string.IsNullOrEmpty(Request.QueryString["page"]) && Request.QueryString["page"] == "saed")
                {
                    ...
                    SessionWrapper.c_facility_name = row.Cells[0].Text;
                    SessionWrapper.c_session_facility_id_fk = gvsearchDetails.DataKeys[index]["c_facility_system_id_pk"].ToString();
