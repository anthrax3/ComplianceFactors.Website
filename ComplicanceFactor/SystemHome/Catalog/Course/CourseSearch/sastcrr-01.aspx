...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function DeleteAnd() {
            $('#<%=dlstCourseSelected.ClientID %> tr td:last').eq(-1).css("display", "none");
        }
    </script>
    <script type="text/javascript" language="javascript">
...
<body>
    ...
    <div>
        <div id="courseselected" runat="server" style="display: none;">
            ...
            <br />
            <div>
                <asp:DataList ID="dlstCourseSelected" Width="740px" runat="server" RepeatColumns="2"
                    DataKeyField="c_related_course_id_fk" RepeatDirection="Horizontal" OnItemCommand="dlstCourseSelected_ItemCommand">
                    <ItemTemplate>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 80px;">
                                    <asp:Button ID="btnRemove" CssClass="cursor_hand" OnClientClick="return confirmremove();" CommandName="Remove"
                                        CommandArgument='<%#Container.ItemIndex %>' runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text%>" />
                                </td>
                                <td class="red_color">
                                    *and*
                                </td>
                ...
                <asp:Button ID="btnSaveandExit" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_save_and_exit_button_text%>" OnClick="btnSaveandExit_Click" />
            </div>
             <br />
        </div>
       
        <div class="div_header_popup_1">
            <%=LocalResources.GetLabel("app_course_search_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_popup_1 tablesorter"
                ...
                EmptyDataRowStyle-CssClass="empty_row" DataKeyNames="c_course_id_pk,c_course_version,c_course_system_id_pk"
