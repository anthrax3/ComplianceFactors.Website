<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="sacsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Instructor.sacsr_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function resetall() {
            ...
            document.getElementById('<%=txtCourseTitle.ClientID %>').value = '';
            return false;
        }
    </script>
    <div id="content">
        <div class="div_header_700">
            <%=LocalResources.GetLabel("app_course_search_result_text")%>:
        </div>
        <br />
        <div>
            ...
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_2" ItemStyle-CssClass="gridview_row_width_2"
                        HeaderText="<%$ LabelResourceExpression: app_delivery_type_text %>" DataField='c_delivery_type_name'
                        HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
