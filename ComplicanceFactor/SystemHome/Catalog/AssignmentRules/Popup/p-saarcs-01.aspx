<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="p-saarcs-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.AssignmentRules.Popup.p_saarcs_01" %>
        ...
        <div id="content">
            ...
            <div>
                <table class="table_td_300">
                    <tr>
                        <td>
                            <asp:Button ID="btnGoSearch" runat="server" 
                                Text="<%$ LabelResourceExpression: app_go_search_button_text %>" 
