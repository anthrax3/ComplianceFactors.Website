<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="p-saargsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.AssignmentRules.Popup.p_saargsr_01" %>
    ...
    <div id="content">
        ...
        <div class="div_padding_25">
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                ...
                PagerSettings-Visible="false" PageSize="5" DataKeyNames="u_assignment_group_system_id_pk"
