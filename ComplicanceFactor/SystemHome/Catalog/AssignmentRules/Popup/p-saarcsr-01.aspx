<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="p-saarcsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.AssignmentRules.Popup.p_saarcsr_01" %>
    ...
    <div id="content">
        ...
        <div class="div_padding_25">
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                ...
                PagerSettings-Visible="false" PageSize="5" DataKeyNames="sysId"
                    ...
                    <tr>
                        <td colspan="2" class="align_left">
                            <asp:Button ID="btnGoSearch" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_go_search_button_text %>"
                               OnClick="btnGosearch_Click"  runat="server" />
                        </td>
                        <td class="align_left">
