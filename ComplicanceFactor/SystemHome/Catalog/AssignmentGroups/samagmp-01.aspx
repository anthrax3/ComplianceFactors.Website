<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="samagmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.AssignmentGroups.samagmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content_area_long">
        <div class="div_header_long">
           <%=LocalResources.GetLabel("app_advanced_assignment_groups_search_results_text")%>:
        </div>
        <br />
        <div>
            ...
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="Assignment Group ID" HeaderStyle-HorizontalAlign="Center" DataField=""
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="Assignment Group Name" HeaderStyle-HorizontalAlign="Center" DataField=""
                        ItemStyle-HorizontalAlign="Left" />
        ...
        <br />
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_assignment_groups_search_text")%>:
        </div>
        <br />
                ...
                <tr>
                    <td colspan="2" class="btnsave_new_user_td">
                        <asp:Button ID="btnAddNewCurriculum" CssClass="cursor_hand" runat="server" 
                            Text="Create New AssignmentGroups" onclick="btnAddNewCurriculum_Click"/>
                    </td>
                    <td>
                    </td>
                    <td>
