<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saanlin-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Locations.saanlin_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <script src="../../../Scripts/jquery-1.7.2.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnManageLocale").fancybox({
                ...
                'href': '../Locations/Locale/savloc-01.aspx?mode=create',
                'onComplete': function () {
    ...
    <br />
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saanlin" runat="server"
        ValidationGroup="saanlin"></asp:ValidationSummary>
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveNewLocation" ValidationGroup="saanlin" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_new_location_button_text %>" 
                            onclick="btnHeaderSaveNewLocation_Click" />
                    </td>
                    <td align="left">
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLocationId" runat="server" ValidationGroup="saanlin"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLocationName" runat="server" ValidationGroup="saanlin"
                ...
                <tr>
                    <td valign="top">
                        <asp:RequiredFieldValidator ID="rfvLocationDescription" runat="server" ValidationGroup="saanlin"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewLocation" ValidationGroup="saanlin" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_new_location_button_text %>" 
                            onclick="btnFooterSaveNewLocation_Click" />
                    </td>
                    <td align="left">
