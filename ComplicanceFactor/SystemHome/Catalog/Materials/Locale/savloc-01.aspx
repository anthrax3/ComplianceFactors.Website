<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="savloc-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Materials.Locale.savloc_01" %>
 ...
 <script src="../../../../Scripts/jquery-1.7.2.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var editMaterialId = $.QueryString("materialid"),
            editMaterialId = (!editMaterialId) ? "null" : editMaterialId; // Passing the value null to string
            ...
            $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'href': '../Locale/saaloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&editMaterialId=" + editMaterialId,
                    'onComplete': function () {
