...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="div_padding_25">
        <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
            ...
            EmptyDataRowStyle-CssClass="empty_row" PagerSettings-Visible="false" PageSize="5" DataKeyNames="sysId"
            ...
            <Columns>
                <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                    HeaderText="<%$ LabelResourceExpression: app_catalog_item_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField="Id" ItemStyle-HorizontalAlign="Left" />
                <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                    HeaderText="<%$ LabelResourceExpression: app_catalog_item_id_text %>" HeaderStyle-HorizontalAlign="Center" DataField="title"  ItemStyle-HorizontalAlign="Left" />
