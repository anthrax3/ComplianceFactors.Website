<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samfimp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Facilities.samfimp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            ...
            document.getElementById('<%=ddlFacilityType.ClientID %>').selectedIndex = '0';
            document.getElementById('<%=txtFacilityCity.ClientID %>').value = '';
            return false;
        }
    </script>
    <br />
    <div class="content_area_long">
        ...
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_facilities_search_results_text")%>:
        </div>
        <br />
        <div>
            ...
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_facility_id_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="c_facility_id_pk" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_facility_name_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="c_facility_name" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_2" ItemStyle-CssClass="gridview_row_width_2"
                        HeaderText="<%$ LabelResourceExpression: app_facility_city_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="c_facility_city" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_facility_type_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_facility_type_name_us_english" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_status_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_status_name" ItemStyle-HorizontalAlign="Center" />
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_facilities_search_text")%>:
            </div>
            <br />
            <div class="div_controls font_1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <%=LocalResources.GetLabel("app_facility_city_text")%>:
                        </td>
                        <td>
                            <asp:TextBox ID="txtFacilityCity" CssClass="textbox_long" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewFacility" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_facility_button_text %>"
