<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="savloc-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Facilities.Locale.savloc_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var editlocationId = $.QueryString("facilityid"),
            ...
            $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'href': '../Locale/saaloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&editFacilityId=" + editlocationId,
                    'onComplete': function () {
