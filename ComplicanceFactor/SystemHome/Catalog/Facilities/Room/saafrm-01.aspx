<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="saafrm-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Facilities.Room.saafrm_01" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnAddResource").fancybox({
                ...
                'href': '../Room/Resource/safrmrs-01.aspx?mode=create',
                'onComplete': function () {
            ...
            $(".deleteresource").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saafrm-01.aspx/DeleteResource",
