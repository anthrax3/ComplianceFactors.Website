<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="saefrm-02.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Catalog.Facilities.Room.saefrm_02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var message = $.QueryString("editRoomId"),
            ...
            $("#btnAddResource").fancybox({
                ...
                'href': '../Room/Resource/safrmrs-01.aspx?mode=edit&editRoomId=' + message,
                'onComplete': function () {
            ...
            $(".deleteresource").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saefrm-02.aspx/DeleteResource",
    ...
    <div>
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvRoomId" runat="server" ValidationGroup="saefrm"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvRoomName" runat="server" ValidationGroup="saefrm"
                ...
                <tr>
                    <td valign="top">
                        <asp:RequiredFieldValidator ID="rfvRoomDescription" runat="server" ValidationGroup="saefrm"
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlRoomType" DataValueField="s_room_type_system_id_pk" DataTextField="s_room_type_name"
                            CssClass="ddl_user_advanced_search" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                                ...
                                <tr>
                                  ...
                                  <%--  <td class="gridview_row_width_300">
                                    ...
                                    <td class="gridview_row_width_300" align="center">
                                        <input type="button" id='<%# Eval("s_room_resource_system_id_pk") %>' value='<asp:Literal ID="Literal1" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
        ...
        <div class="div_padding_10">
            <div class="left">
                <asp:Button ID="btnSave" ValidationGroup="saefrm" CssClass="cursor_hand" runat="server"
                    Text="<%$ LocalizationResourceExpression: app_save_room_button_text %>" OnClick="btnSave_Click" />
            </div>
            <div>
                <div class="right">
