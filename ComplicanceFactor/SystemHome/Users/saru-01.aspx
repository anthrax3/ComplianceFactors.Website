        ...
        <div class="home_content">
                ...
                <table class="button_div">
                    <tr>
                        <td class="btnsave_new_user_td">
                            <asp:Button ID="btnConfirm_header" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_confirm_retire_button_text %>"
                                runat="server" OnClick="btnConfirm_header_Click" />
                        </td>
            ...
            <div class="add_edit_user_tab">
                <table class="button_div">
                    <tr>
                        <td class="btnsave_new_user_td">
                            <asp:Button ID="btnConfirm_footer" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_confirm_retire_button_text %>"
                                runat="server" OnClick="btnConfirm_footer_Click" />
                        </td>
                        <td class="btnreset_td">
                            &nbsp;
                        </td>
