<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saau-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.saau_01"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            ...
            document.getElementById('<%=btnManager.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnManagerRemove.ClientID %>').style.display = "none";

            document.getElementById('<%=btnSupervisor.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnRemoveSupervisor.ClientID %>').style.display = "none";

            document.getElementById('<%=btnMentor.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnRemoveMentor.ClientID %>').style.display = "none";

            document.getElementById('<%=btnAltManager.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnRemoveAltManager.ClientID %>').style.display = "none";

            document.getElementById('<%=btnAltSupervisor.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnRemoveAltSupervisor.ClientID %>').style.display = "none";

            document.getElementById('<%=btnAltMentor.ClientID %>').style.display = "inline";
            document.getElementById('<%=btnRemoveAltMentor.ClientID %>').style.display = "none";
            return true;
    ...
    <%-- <script type="text/javascript">
        ...
        $(document).keypress(function (e) {
            ...
            var pnlsearch = document.getElementById('<%=pnlSelectUser.ClientID %>').style.display;
            var pnlSearchResult = document.getElementById('<%=pnlSearchResult.ClientID %>').style.display;
            if (e.which == 13 && pnlsearch != "none") {

                document.getElementById('<%=btnGosearch.ClientID %>').click();
                return true;

            }
            if (e.which == 13 && pnlSearchResult != "none") {

                document.getElementById('<%=btnResultGoSearch.ClientID %>').click();
                return true;
    ...
    <asp:ValidationSummary CssClass="validation_summary_error" ID="vs_saau" runat="server"
        ValidationGroup="saau" />
    <asp:CustomValidator ID="cvSecurityRoles" EnableClientScript="true" ClientValidationFunction="checkroles"
        ValidationGroup="saau" runat="server" ErrorMessage="<%$ TextResourceExpression: app_security_role_error_empty %>">&nbsp;</asp:CustomValidator>
    <div id="success_msg" runat="server" class="msgarea_success" style="display: none;">
        <%=LocalResources.GetText("app_succ_insert_text")%>
    </div>
    ...
    <div class="content_area_long">
        <div class="div_controls">
            <table class="div_table">
                <tr>
                    <td class="align_left">
                        <asp:Button ID="btnSavenewuser_header" CssClass="cursor_hand" ValidationGroup="saau"
                            Text="<%$ LabelResourceExpression: app_save_new_user_button_text %>" runat="server"
                            OnClick="btnSavenewuser_header_Click" />
                    </td>
                    <td class="btnreset_td">
                        <asp:Button ID="btnReset_header" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_reset_button_text %>"
                            OnClientClick="return resetall();" OnClick="btnReset_header_Click" />
                    </td>
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ValidationGroup="saau"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ValidationGroup="saau"
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvUserName" runat="server" ValidationGroup="saau"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ValidationGroup="saau"
        ...
        <br />
        <asp:UpdatePanel ID="upnlSaau" runat="server">
            <ContentTemplate>
                <div class="div_controls font_1">
                    <table>
                        <tr>
                            ...
                            <td class="text_align" style="width: 325px;" colspan="2">
                                ...
                                <asp:Button ID="btnManagerRemove" OnClick="btnManagerRemove_Click" CssClass="cursor_hand"
                                    Style="display: none;" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                            <td>
                            ...
                            <td class="text_align" style="white-space: nowrap;" colspan="2">
                                ...
                                <asp:Button ID="btnRemoveAltManager" OnClick="btnRemoveAltManager_Click" CssClass="cursor_hand"
                                    Style="display: none;" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text_align" colspan="2">
                                ...
                                <asp:Button ID="btnRemoveSupervisor" OnClick="btnRemoveSupervisor_Click" CssClass="cursor_hand"
                                    Style="display: none;" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                            <td>
                            ...
                            <td class="align_left" style="white-space: nowrap;" colspan="2">
                                ...
                                <asp:Button ID="btnRemoveAltSupervisor" OnClick="btnRemoveAltSupervisor_Click" CssClass="cursor_hand"
                                    Style="display: none;" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text_align" colspan="2">
                                ...
                                <asp:Button ID="btnRemoveMentor" OnClick="btnRemoveMentor_Click" CssClass="cursor_hand"
                                    Style="display: none;" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                            <td>
                            ...
                            <td class="align_left" style="white-space: nowrap;" colspan="2">
                                ...
                                <asp:Button ID="btnRemoveAltMentor" OnClick="btnRemoveAltMentor_Click" Style="display: none;"
                                    runat="server" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
        ...
        <div class="div_controls">
            <table class="div_table">
                <tr>
                    <td class="align_left">
                        <asp:Button ID="btnsavenewuser_footer" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_save_new_user_button_text %>"
                            runat="server" ValidationGroup="saau" OnClick="btnsavenewuser_footer_Click" />
                    </td>
                    <td class="btnreset_td">
                        <asp:Button ID="btnreset_footer" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_reset_button_text %>"
                            OnClientClick=" resetall();" OnClick="btnreset_footer_Click" />
                    </td>
                    <td class="align_right">
        ...
        <div>
                    ...
                    <asp:UpdatePanel runat="server" ID="updatePanel3">
                        <ContentTemplate>
                            ...
                            <div class="remove_content">
                                ...
                                <div class="left">
                                    <asp:Button ID="btnRemoveSubmit" runat="server" CssClass="cursor_hand" Text="<%$ LabelResourceExpression: app_confirm_button_text %>"
            ...
            <asp:ModalPopupExtender ID="mpeRemove" runat="server" TargetControlID="btnRemove"
                OkControlID="btnRemoveCancel" CancelControlID="imgClose" PopupControlID="pnlRemove"
                BackgroundCssClass="transparent_class" DropShadow="false" PopupDragHandleControlID="pnlRemoveHeading">
