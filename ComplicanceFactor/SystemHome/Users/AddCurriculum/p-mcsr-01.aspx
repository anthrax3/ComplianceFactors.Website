<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="p-mcsr-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Users.AddCurriculum.p_mcsr_01" %>
    ...
    <div id="content">
        ...
        <div class="div_padding_25">
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                ...
                PagerSettings-Visible="false" PageSize="5" DataKeyNames="sysId" OnPageIndexChanging="gvsearchDetails_PageIndexChanging"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_catalog_item_name_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="Id" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_catalog_item_id_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="title" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_2" ItemStyle-CssClass="gridview_row_width_2"
                        HeaderText="<%$ LabelResourceExpression: app_item_type_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="type" ItemStyle-HorizontalAlign="Left" />
