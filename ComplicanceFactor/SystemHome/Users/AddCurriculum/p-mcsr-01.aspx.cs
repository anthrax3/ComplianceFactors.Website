    ...
    public partial class p_mcsr_01 : System.Web.UI.Page
    {
        ...
        private void SearchResult()
        {
            try
            {
                ...
                {
                    curriculumid = txtCatalogItemId.Text;
                    curriculumtitle = txtCatalogItemName.Text;
                }
                else
                {
                    curriculumid = SecurityCenter.DecryptText(Request.QueryString["id"]);
                    curriculumtitle = SecurityCenter.DecryptText(Request.QueryString["name"]);
                }
                gvsearchDetails.DataSource = SystemMassEnrollmentBLL.SearchCurriculum(curriculumid, curriculumtitle);
