    ...
    public partial class edit_grading_value : System.Web.UI.Page
    {
        ...
        protected void btnSaveAndAdd_Click(object sender, EventArgs e)
        {
            ...
            else if (!string.IsNullOrEmpty(Request.QueryString["page"]) && Request.QueryString["page"] == "saegs")
            {
                ...
                updateGradingSchemeValues.s_grading_scheme_value_min_score =  txtMinScore_InPercentage.Text;
                updateGradingSchemeValues.s_grading_scheme_value_max_score = Convert.ToInt32(txtMaxScore_InPercentage.Text);
                updateGradingSchemeValues.s_grading_scheme_value_grade = txtGrade.Text;
                updateGradingSchemeValues.s_grading_scheme_value_min_num = txtMinScore_InNumbers.Text;
                updateGradingSchemeValues.s_grading_scheme_value_max_num = txtMaxScore_InNumbers.Text;
