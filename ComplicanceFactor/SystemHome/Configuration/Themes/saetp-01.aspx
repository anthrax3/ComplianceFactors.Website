...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function validateColorCode() {
         ...
         <script type="text/javascript">
             function validateColor() {
                 ...
                 isValid = Page_ClientValidate('saetp');
                 if (isValid) {
                     isValid = Page_ClientValidate('saetp_validatecolor');
                 }
                 return isValid;
             }
    </script>
    ...
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saantp_validatecolor"
        runat="server" ValidationGroup="saetp_validatecolor"></asp:ValidationSummary>
      <asp:CustomValidator ID="cvValidateColor" EnableClientScript="true" ClientValidationFunction="validateAll"
        ValidationGroup="saetp_validatecolor" runat="server" ErrorMessage="<%$ TextResourceExpression: app_color_code_error_empty_text %>">&nbsp;</asp:CustomValidator>
                ...
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderUpdateTheme" OnClientClick="return validateColor()" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_button_text %>" OnClick="btnHeaderUpdateTheme_Click" />
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterUpdateTheme" OnClientClick ="return validateColor()" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_button_text %>" OnClick="btnFooterUpdateTheme_Click" />
                    </td>
                    <td align="left">
