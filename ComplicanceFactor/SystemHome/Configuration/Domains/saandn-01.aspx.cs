        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    lblBreadCrumb.Text = "<a href=/SystemHome/sahp-01.aspx>" + LocalResources.GetGlobalLabel("app_system_text") + "</a>&nbsp;" + " >&nbsp;" + "<a href=/SystemHome/Configuration/Domains/samdmp-01.aspx>" + LocalResources.GetGlobalLabel("app_manage_domain_text") + "</a>" + " >&nbsp;" + LocalResources.GetGlobalLabel("app_create_new_domain_text");
