<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saectn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.CurriculumTypes.saectn_01" %>
    ...
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveCurriculumType" ValidationGroup="saectn" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_button_text %>" onclick="btnHeaderSaveCurriculumType_Click" />
                    </td>
                    <td align="center">
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCurriculumTypeId" runat="server" ValidationGroup="saectn"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCurriculumTypeName" runat="server" ValidationGroup="saectn"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveCurriculumType" ValidationGroup="saectn" CssClass="cursor_hand"
