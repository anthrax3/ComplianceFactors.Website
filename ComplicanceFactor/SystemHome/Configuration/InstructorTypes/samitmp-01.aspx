<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samitmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.InstructorTypes.samitmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%=gvInstructorTypesDetails.ClientID %>')
    ...
    <script type="text/javascript">
        function resetall() {
            document.getElementById('<%=txtInstructorId.ClientID %>').value = '';
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_instructor_types_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <br />
        <div>
            <asp:GridView ID="gvInstructorTypesDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                DataKeyNames="s_instructor_type_system_id_pk" OnRowCommand="gvInstructorTypesDetails_RowCommand"
                OnRowEditing="gvInstructorTypesDetails_RowEditing" OnPageIndexChanging="gvInstructorTypesDetails_PageIndexChanging">
                <Columns>
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_instructor_types_search_text")%>:
            </div>
            <br />
            <div class="div_controls font_1">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtInstructorId" CssClass="textbox_long" runat="server"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewInstructorType" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_instructor_type_text %>"
                                OnClick="btnAddNewInstructorType_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
