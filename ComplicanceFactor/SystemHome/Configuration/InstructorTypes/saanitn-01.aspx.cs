...
namespace ComplicanceFactor.SystemHome.Configuration.InstructorTypes
{
    public partial class saanitn_01 : BasePage
    {
        ...
        private void SaveInstructorType()
        {
            ...
            instructor.s_instructor_type_system_id_pk = Guid.NewGuid().ToString();
            ...
            try
            {
                ...
                int result = SystemInstructorTypeBLL.CreateInstructorType(instructor);

                if (result == 0)
                {
                    Response.Redirect("~/SystemHome/Configuration/InstructorTypes/saeitn-01.aspx?id=" + SecurityCenter.EncryptText(instructor.s_instructor_type_system_id_pk) + "&succ=" + SecurityCenter.EncryptText("true"), false);
                }
        ...
        private void PoulateInstructor(string editInstructorId)
        {
            ...
            try
            {
                ...
                txtInstructorTypeId.Text = instructor.s_instructor_type_id + "_Copy";
