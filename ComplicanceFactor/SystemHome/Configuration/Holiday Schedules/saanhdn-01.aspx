<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saanhdn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Holiday_Schedules.saanhdn_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=btnAddNewHoliday.ClientID %>").fancybox({
                ...
                'href': 'p-sahs-01.aspx?mode=create',
                'onComplete': function () {
        ...
        $(document).ready(function () {
            ...
            $(".editHoliday").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': 'p-sehs-01.aspx?mode=edit&page=saanhdn' + "&id=" + record_id,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
            ...
            $(".removeHoliday").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "saanhdn-01.aspx/DeleteHoliday",
    ...
    <br />
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saanhdn" runat="server"
        ValidationGroup="saanhdn"></asp:ValidationSummary>
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveNewHolidaySchedule" CssClass="cursor_hand" runat="server"
                            Text="<%$ LabelResourceExpression: app_save_new_holiday_schedule_button_text %>" ValidationGroup="saanhdn" OnClick="btnHeaderSaveNewHolidaySchedule_Click" />
                    </td>
                    <td align="left">
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvScheduleId" runat="server" ValidationGroup="saanhdn"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvScheduleName" runat="server" ValidationGroup="saanhdn"
                ...
                <tr>
                    <td valign="top">
                        <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ValidationGroup="saanhdn"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewHolidaySchedule" CssClass="cursor_hand" runat="server"
                            Text="<%$ LabelResourceExpression: app_save_new_holiday_schedule_button_text %>" ValidationGroup="saanhdn" OnClick="btnFooterSaveNewHolidaySchedule_Click" />
                    </td>
                    <td align="left">
