<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="p-sahs-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Holiday_Schedules.p_sahs_01" %>
   ...
   <div id="content">
        ...
        <div>
                ...
                <table cellpadding="3" cellspacing="3">
                    <tr>
                        <td valign="top" class="align_right">
                            <asp:RequiredFieldValidator ID="rfvHolidayName" runat="server" ValidationGroup="addholiday"
                    ...
                    <tr>
                        <td valign="top" class="align_right">
                            <asp:RequiredFieldValidator ID="rfvDate" runat="server" ValidationGroup="addholiday"
                        ...
                        <td class="align_left">
                            <asp:RegularExpressionValidator ID="regexDate" runat="server" ControlToValidate="txtDate"
                                ...
                                ErrorMessage="<%$ TextResourceExpression: app_date_error_wrong %>" Display="Dynamic" ValidationGroup="addholiday">&nbsp;</asp:RegularExpressionValidator>
                    ...
                    <tr>
                        <td valign="top" class="align_right">
                            <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ValidationGroup="addholiday"
            ...
            <div class="div_padding_10">
                <div class="left">
                    <asp:Button ID="btnSaveHoliday" ValidationGroup="addholiday" runat="server" Text="<%$ LabelResourceExpression: app_save_holiday_button_text %>"
