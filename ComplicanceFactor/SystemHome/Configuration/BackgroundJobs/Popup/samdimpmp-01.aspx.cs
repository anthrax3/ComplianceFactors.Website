    ...
    public partial class samdimpmp_01 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    dimpId = Request.QueryString["Id"].ToString();
                }

                PopulateDataImport(dimpId);
            }
        }
        ...
        /// </summary>
        private void PopulateDataImport(string dimpId)
        {
            SystemHRISIntegration dataImport = new SystemHRISIntegration();
            try
            {
                dataImport = SystemBackgroundJobsBLL.GetSingleDataImport(dimpId);
