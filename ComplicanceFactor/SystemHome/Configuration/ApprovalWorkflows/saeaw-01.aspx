<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="saeaw-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.ApprovalWorkflows.saeaw_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#<%=btnFirstLevelApprover.ClientID %>").fancybox({
                ...
                'href': '/SystemHome/sasumsm-01.aspx?specificFirstLevelApprover=true&page=saeaw',
                'onComplete': function () {
      ...
      <script type="text/javascript">
          $(document).ready(function () {
              ...
              $("#<%=btnSecondLevelApprover.ClientID %>").fancybox({
                  ...
                  'overlayOpacity': 0.7,
                  'hideOnOverlayClick': false,
                  'href': '/SystemHome/sasumsm-01.aspx?specificSecondLevelApprover=true&page=saeaw',
                  'onComplete': function () {
                      $('#fancybox-frame').load(function () {
                          $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                          var heightPane = $(this).contents().find('#content').height();
              ...
              $(document).ready(function () {
                  ...
                  $("#<%=btnThirdLevelApprover.ClientID %>").fancybox({
                      ...
                      'overlayOpacity': 0.7,
                      'hideOnOverlayClick': false,
                      'href': '/SystemHome/sasumsm-01.aspx?specificThirdLevelApprover=true&page=saeaw',
                      'onComplete': function () {
                          $('#fancybox-frame').load(function () {
                              $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                              var heightPane = $(this).contents().find('#content').height();
    ...
    <br />
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saeaw" runat="server"
        ValidationGroup="saeaw"></asp:ValidationSummary>
    <div id="divSuccess" runat="server" class="msgarea_success" style="display:none;">
    </div>
    <div id="divError" runat="server" class="msgarea_error" style="display:none">
    </div>
    <asp:HiddenField ID="hdApprovalWorkflow" runat="server" />
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveNewApprovalWorkflow" CssClass="cursor_hand" runat="server"
                            Text="<%$ LabelResourceExpression: app_save_button_text %>" ValidationGroup="saeaw" 
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvApprovalWorkflowName" runat="server" ValidationGroup="saeaw"
                ...
                <tr>
                    ...
                    <td class="align_left" colspan="6">
                     <asp:RequiredFieldValidator ID="rfvDescriptionUS" runat="server" ValidationGroup="saeaw"
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" DataTextField="s_status_name"
                            DataValueField="s_status_id_pk" CssClass="ddl_user_advanced_search" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
      ...
      <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="align_left">
                        ...
                        <asp:Button ID="btnFirstLevelApprover" runat="server" Text="Select" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td class="align_left">
                        ...
                        <asp:Button ID="btnSecondLevelApprover" runat="server"  Text="Select" />
                    </td>
                </tr>
                <tr>
                    <td>
                   ...
                   <td class="align_left">
                        ...
                        <asp:Button ID="btnThirdLevelApprover" runat="server" Text="Select" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtApprovalWorkfkowNameUK" CssClass="textbox_long" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        &nbsp;
                    </td>
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewApprovalWorkflow"  CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_button_text %>" ValidationGroup="saeaw" 
