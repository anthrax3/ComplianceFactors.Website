<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samawmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.ApprovalWorkflows.samawmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            document.getElementById('<%=txtApprovalWorkflowId.ClientID %>').value = '';
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_approval_workflow_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                DataKeyNames="s_approval_workflow_system_id_pk" EmptyDataRowStyle-CssClass="empty_row"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_approval_workflow_id_text %>" HeaderStyle-HorizontalAlign="Center" DataField="s_approval_workflow_id"
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_approval_workflow_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField="s_approval_workflow_name_us_english"
                        ItemStyle-HorizontalAlign="Left" />
        ...
        <br />
        <div class="div_header_long">
             <%=LocalResources.GetLabel("app_advanced_approval_workflow_search_text")%>:
        </div>
        <br />
       <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtApprovalWorkflowId" CssClass="textbox_manage_user" runat="server"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2" class="btnsave_new_user_td">
                        <asp:Button ID="btnCreateNewApprovalWorkflow" CssClass="cursor_hand" runat="server"
                            Text="<%$ LabelResourceExpression: app_create_new_approval_workflow_button_text %>" OnClick="btnCreateNewApprovalWorkflow_Click" />
                    </td>
                    <td>
                        &nbsp;
                    </td>
