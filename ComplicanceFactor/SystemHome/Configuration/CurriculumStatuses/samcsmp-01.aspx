<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="samcsmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Curriculum_Statuses.samcsmp_01" %>
...
<script src="../../../Scripts/jquery-1.7.2.min.js" type="text/javascript"></script>
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_curriculum_status_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_curriculum_status_search_text")%>:
            </div>
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewCurriculamStatus" CssClass="cursor_hand" 
                                runat="server" 
                                Text="<%$ LabelResourceExpression: app_create_new_curriculum_status_button_text %>" 
                                onclick="btnAddNewCurriculamStatus_Click"/>
                        </td>
                        <td>
                            &nbsp;
                        </td>
