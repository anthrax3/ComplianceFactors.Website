<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="sammtmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.MaterialTypes.sammtmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
     ...
     <script type="text/javascript">
         ...
         $(function () {
             $('#<%=gvMaterialTypesDetails.ClientID %>')
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_material_types_search_results_text")%>: 
        </div>
        <br />
        <div>
            ...
            <asp:GridView ID="gvMaterialTypesDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_material_type_id_text %>" HeaderStyle-HorizontalAlign="Center" DataField='s_material_type_id'
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_material_type_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField='s_material_type_name_us_english'
                        ItemStyle-HorizontalAlign="Left" />
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_material_types_search_text")%>: 
            </div>
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewMaterialType" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_material_type_button_text %>"
                                OnClick="btnAddNewMaterialType_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
