    ...
    <div class="content_area_long">
        ...
        <div class="table_td_300">
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <a href="UI Texts and Labels/samuiltdp-01.aspx">
                            <%=LocalResources.GetLabel("app_manage_ui_texts_labels_dropdown_text")%></a>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <tr>
                    <td>
                        <a href="RoomTypes/samrotmp-01.aspx"><%=LocalResources.GetLabel("app_manage_room_types_text")%></a>
                    </td>
                    <td>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <a href="ApprovalWorkflows/samawmp-01.aspx">Manage Approval Workflows</a>
                    </td>
                    <td>
                        <a href="#"></a>
                    </td>
