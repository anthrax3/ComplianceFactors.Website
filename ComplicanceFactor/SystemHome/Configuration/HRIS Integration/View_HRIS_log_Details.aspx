<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="View_HRIS_log_Details.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.HRIS_Integration.View_HRIS_log_Details" %>
            ...
            <table>
                <tr>
                    <td class="align_left" colspan="8">
                        <textarea id="txtHrisLogDetails" runat="server" rows="30" cols="77"></textarea>
                    </td>
                </tr>
            </table>
        </div>
