<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saedoctn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.DocumentTypes.saedoctn_01" %>
    ...
    <div class="content_area_long">
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnHeaderSave" CssClass="cursor_hand" runat="server" ValidationGroup="saedoctn"
        ...
        <div class="div_controls font_1">
            <table cellpadding="5" cellspacing="10">
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvDocumentTypeId" runat="server" ValidationGroup="saedoctn"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvDocumentTypeName" runat="server" ValidationGroup="saedoctn"
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <asp:RequiredFieldValidator ID="rfvDocumentTypeDescription" runat="server" ValidationGroup="saedoctn"
                            ControlToValidate="txtDocumentTypeDescription_EnglishUs" ErrorMessage="<%$ TextResourceExpression: app_description_error_empty %>">&nbsp;
                        </asp:RequiredFieldValidator>
                        <asp:TextBox ID="txtDocumentTypeDescription_EnglishUs" TextMode="MultiLine" Rows="7"
                            Width="672px" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
