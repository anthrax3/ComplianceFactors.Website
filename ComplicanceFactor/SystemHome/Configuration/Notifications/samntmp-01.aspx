<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samntmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Notification.samntmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            document.getElementById('<%=txtNotificationId.ClientID %>').value = '';
            document.getElementById('<%=txtNotificationName.ClientID %>').value = '';
    ...
    <div class="content_area_long">
        <div class="div_header_long">
           <%=LocalResources.GetLabel("app_advanced_notifications_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                DataKeyNames="s_notification_system_id_pk" OnRowCommand="gvsearchDetails_RowCommand"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_notification_id_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_notification_id_pk" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_notification_name_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_notification_name" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_type_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        DataField="s_notification_type_id_fk" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_status_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        DataField="s_notification_flag" />
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_1"
                        ...
                        <ItemTemplate>
                            ...
                            <asp:Button ID="btnTurnOff" CommandName="Off" style="display:none;" CssClass="cursor_hand" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>'
                                runat="server" OnClientClick="return confirmStatus();" Text="<%$ LabelResourceExpression: app_turn_off_button_text %>" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
               <%=LocalResources.GetLabel("app_advanced_notification_search_text")%>:
            </div>
            <br />
            <div class="div_controls font_1">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNotificationId" CssClass="textbox_long" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <%=LocalResources.GetLabel("app_name_text")%>:
                        </td>
                        <td>
                            <asp:TextBox ID="txtNotificationName" CssClass="textbox_long" runat="server"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlType" CssClass="ddl_user_advanced_search" runat="server">
                                <asp:ListItem Text="All" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Triggered" Value="Triggered"></asp:ListItem>
