<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samrtmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.ResourceTypes.samrtmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%=gvResourceTypesDetails.ClientID %>')
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_resource_types_search_results_text")%>: 
        </div>
        <br />
        <div>
        ...
        <br />
        <div>
            <asp:GridView ID="gvResourceTypesDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                runat="server" EmptyDataText="No result found." DataKeyNames="s_resource_type_system_id_pk"
                AutoGenerateColumns="False" AllowPaging="true" EmptyDataRowStyle-CssClass="empty_row"
                PagerSettings-Visible="false" PageSize="10" OnRowCommand="gvResourceTypesDetails_RowCommand"
                OnRowEditing="gvResourceTypesDetails_RowEditing">
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_resource_type_id_text %>" HeaderStyle-HorizontalAlign="Center" DataField='s_resource_type_id'
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_resource_type_name_text %>" HeaderStyle-HorizontalAlign="Center" DataField='s_resource_type_name_us_english'
                        ItemStyle-HorizontalAlign="Left" />
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_resource_types_search_text")%>:
            </div>
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewResourceType" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_resource_type_button_text %>"
                                OnClick="btnAddNewResourceType_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
