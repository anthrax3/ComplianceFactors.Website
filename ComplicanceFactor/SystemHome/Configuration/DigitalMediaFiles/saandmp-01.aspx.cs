    ...
    public partial class saandmp_01 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblBreadCrumb.Text = navigationText + "&nbsp;" + " >&nbsp;" + "<a href=/SystemHome/Configuration/DigitalMediaFiles/samdmmp-01.aspx>" + LocalResources.GetGlobalLabel("app_manage_digital_media_files_text") + "</a>&nbsp;" + " >&nbsp;" + LocalResources.GetGlobalLabel("app_create_new_media_files_text");
