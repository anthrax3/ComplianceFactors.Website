<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="sametmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.EmployeeTypes.sametmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanecd_employee_types_search_results_text")%> 
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                DataKeyNames="s_employee_type_system_id_pk" EmptyDataRowStyle-CssClass="empty_row"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_employee_type_id_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_employee_type_id" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_employee_type_name_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_employee_type_name_us_english" />
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
               <%=LocalResources.GetLabel("app_advanced_employee_types_search_text")%> 
            </div>
            <br />
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewEmployeeType" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_employee_type_button_text %>"
                                OnClick="btnAddNewEmployeeType_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
