<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samdtmp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.DeliveryTypes.samdtmp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            ...
            document.getElementById('<%=txtDeliveryName.ClientID %>').value = '';
            document.getElementById('<%=ddlStatus.ClientID %>').selectedIndex = '0';
            document.getElementById('<%=ddlDeliveryMode.ClientID %>').selectedIndex = '0';
            return false;
        }
    ...
    <div class="content_area_long">
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_delivery_types_search_results_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                DataKeyNames="s_delivery_type_system_id_pk" EmptyDataRowStyle-CssClass="empty_row"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_delivery_type_id_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_delivery_type_id" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4_1" ItemStyle-CssClass="gridview_row_width_4_1"
                        HeaderText="<%$ LabelResourceExpression: app_delivery_type_name_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                        DataField="s_delivery_type_name_us_english" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_delivery_mode_text %>" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                        DataField="s_delivery_mode_name" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            <div class="div_header_long">
                <%=LocalResources.GetLabel("app_advanced_delivery_types_search_text")%>:
            </div>
            <br />
            <div class="div_controls font_1">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDeliveryMode" CssClass="ddl_user_advanced_search"  runat="server"
                             DataTextField="s_delivery_mode_name" DataValueField="s_delivery_mode_id_pk">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewDeliveryType" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_delivery_type_button_text %>"
                                OnClick="btnAddNewDeliveryType_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
