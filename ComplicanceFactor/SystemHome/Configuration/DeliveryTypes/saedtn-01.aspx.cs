    ...
    public partial class saedtn_01 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lblBreadCrumb.Text = "<a href=/SystemHome/sahp-01.aspx>" + LocalResources.GetGlobalLabel("app_nav_system") + "</a>&nbsp;" + " >&nbsp;" + "<a href=/SystemHome/Configuration/DeliveryTypes/samdtmp-01.aspx>" + LocalResources.GetLabel("app_manage_delivery_type_text") + "</a>&nbsp;" + " >&nbsp;" + LocalResources.GetLabel("app_edit_delivery_type_text");
