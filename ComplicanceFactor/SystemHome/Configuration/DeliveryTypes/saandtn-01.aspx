<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saandtn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.DeliveryTypes.saandtn_01" %>
                ...
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewDeliveryType" CssClass="cursor_hand" ValidationGroup="saandtn"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_new_delivery_type_button_text %>" OnClick="btnFooterSaveNewDeliveryType_Click" />
                    </td>
                    <td align="left">
