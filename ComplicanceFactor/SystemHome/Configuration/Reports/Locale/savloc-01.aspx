<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="savloc-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Reports.Locale.savloc_01" %>
        ...
        $(document).ready(function () {
            ...
            $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'href': 'saaloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&id=" + Id,
                    'onComplete': function () {
            ...
            $(".editlocale").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': 'saeloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&lsid=" + record_id,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
                ...
                <asp:GridView ID="gvLocale" RowStyle-CssClass="record" CssClass="grid_700" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="width_35" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("s_locale_system_id_pk").ToString() + "," +  Eval("s_locale_id_pk").ToString() + "," +  Eval("s_locale_text").ToString()%>' value='<asp:Literal ID="Literal6" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
