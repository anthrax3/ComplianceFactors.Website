<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saanrotn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.RoomTypes.saanrotn_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saanrotn" runat="server"
        ValidationGroup="saanrotn"></asp:ValidationSummary>
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveNewRoomType" ValidationGroup="saanrotn" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_new_Room_type_button_text %>"  
                            onclick="btnHeaderSaveNewRoomType_Click" />
                    </td>
                    <td align="left">
                        <asp:Button ID="btnHeaderReset" OnClientClick="return resetall();" runat="server"
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                     <asp:RequiredFieldValidator ID="rfvRoomTypelId" runat="server" ValidationGroup="saanrotn"
                    ...
                    <td>
                     <asp:RequiredFieldValidator ID="rfvRoomTypeName" runat="server" ValidationGroup="saanrotn"
                ...
                <tr>
                    <td valign="top">
                     <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ValidationGroup="saanrotn"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewRoomType" ValidationGroup="saanrotn" CssClass="cursor_hand"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_new_Room_type_button_text %>"  
                            onclick="btnFooterSaveNewRoomType_Click" />
                    </td>
                    <td align="left">
                        <asp:Button ID="btnFooterReset" OnClientClick="return resetall();" runat="server"
