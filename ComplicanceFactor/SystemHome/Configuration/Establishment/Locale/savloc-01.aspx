<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="savloc-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Establishment.Locale.savloc_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //                url: "savloc-01.aspx/BindDatatoDropdown",
            //                data: "{}",
            //                dataType: "json",
            //                success: function (data) {
            //                    $.each(data.d, function (key, value) {
            //                        $("#<%=ddlLocale.ClientID %>").append($("<option></option>").val(value.s_locale_id_pk).html(value.s_locale_description));
            //                    });
            //                },
            ...
            var editlocationId = $.QueryString("establishmentid"),
            ...
            $("#btnCreateNewLocale").click(function (e) {
                ...
                $.fancybox({
                    ...
                    'href': '../Locale/saaloc-01.aspx?mode=' + message + '&localeid=' + localeid + "&localeText=" + localeText + "&editestablishmentid=" + editlocationId,
                    'onComplete': function () {
                        ...
                        <asp:TemplateField ItemStyle-CssClass="width_35" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("s_locale_system_id_pk").ToString() + "," +  Eval("s_locale_id_fk").ToString() + "," +  Eval("s_locale_text").ToString()%>'
                                    value='<asp:Literal ID="Literal2" runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text %>" />'
