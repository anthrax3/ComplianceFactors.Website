<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="samemp-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Establishment.samemp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function resetall() {
            document.getElementById('<%=txtEstablishmentId.ClientID %>').value = '';
            document.getElementById('<%=txtEstablishmentName.ClientID %>').value = '';
            document.getElementById('<%=ddlStatus.ClientID %>').selectedIndex = '0';
        
            document.getElementById('<%=txtEstablishmentCity.ClientID %>').value = '';
            return false;
        }
    </script>
    <br />
    <div class="content_area_long">
        ...
        <div class="div_header_long">
            <%=LocalResources.GetLabel("app_advanced_establishment_search_text")%>:
        </div>
        <br />
        <div>
        ...
        <div>
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="gridview_long tablesorter"
                ...
                EmptyDataRowStyle-CssClass="empty_row" DataKeyNames="s_Establishment_system_id_pk"
                ...
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="<%$ LabelResourceExpression: app_establishment_id_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_Establishment_id_pk" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="<%$ LabelResourceExpression: app_establishment_name_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_Establishment_name" ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_2" ItemStyle-CssClass="gridview_row_width_2"
                        HeaderText="<%$ LabelResourceExpression: app_establishment_city_text %>" HeaderStyle-HorizontalAlign="Center"
                        DataField="s_Establishment_city" ItemStyle-HorizontalAlign="Left" />
        ...
        <asp:Panel ID="pnlDefault" runat="server" DefaultButton="btnGosearch">
            ...
            <div class="div_controls font_1">
                <table>
                    ...
                    <tr>
                        <td>
                            <%=LocalResources.GetLabel("app_establishment_city_text")%>:
                        </td>
                        <td>
                             <asp:TextBox ID="txtEstablishmentCity" CssClass="textbox_long" runat="server"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" class="btnsave_new_user_td">
                            <asp:Button ID="btnAddNewEstablishment" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_create_new_establishment_type_button_text %>"
                                OnClick="btnAddNewEstablishment_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
