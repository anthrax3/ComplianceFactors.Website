<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="saanwdn-01.aspx.cs" Inherits="ComplicanceFactor.SystemHome.Configuration.Weekday_Schedules.saanwdn_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:ValidationSummary class="validation_summary_error" ID="vs_saanwdn" runat="server"
        ValidationGroup="saanwdn"></asp:ValidationSummary>
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnHeaderSaveNewWeekdaySchedule" CssClass="cursor_hand" runat="server" ValidationGroup="saanwdn"
                            Text="<%$ LabelResourceExpression: app_save_new_weekday_schedule_button_text %>" OnClick="btnHeaderSaveNewWeekdaySchedule_Click" />
                    </td>
                    <td align="left">
        ...
        <div class="div_controls font_1">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvScheduleId" runat="server" ValidationGroup="saanwdn"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvScheduleName" runat="server" ValidationGroup="saanwdn"
                ...
                <tr>
                    <td valign="top">
                        <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ValidationGroup="saanwdn"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="paging">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnFooterSaveNewWeekdaySchedule" CssClass="cursor_hand" runat="server" ValidationGroup="saanwdn"
                            Text="<%$ LabelResourceExpression: app_save_new_weekday_schedule_button_text %>" OnClick="btnFooterSaveNewWeekdaySchedule_Click" />
                    </td>
                    <td align="left">
