<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="timtdp-01.aspx.cs" Inherits="ComplicanceFactor.Instructor.timtdp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <script type="text/javascript">
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_instructor_todo_text")%><br />
        <br />
        <br />
    </div>
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_footer_instructor_todo_text")%>
        <br />
        <br />
    </div>
    </div>
