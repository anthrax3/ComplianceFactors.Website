<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="tippp-01.aspx.cs" Inherits="ComplicanceFactor.Instructor.tippp_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_instructor_profile_text")%><br />
        <br />
        <br />
    </div>
            ...
            <table cellspacing="0" cellpadding="0" class="gridview_long_no_border">
                <thead>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlCollapsedRoaster" DataValueField="id" DataTextField="name"
                                runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_footer_instructor_profile_text")%>
        <br />
        <br />
    </div>
    </div>
