...
namespace ComplicanceFactor.Compliance.HARM
{
    public partial class cceharm_01 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblBreadCrumb.Text = "<a href=/Compliance/cchp-01.aspx>" + LocalResources.GetGlobalLabel("app_nav_compliance") + "</a>&nbsp;" + " >&nbsp;" + "<a href=/Compliance/HARM/ccasharm-01.aspx>" + LocalResources.GetLabel("app_harm_text") + "</a>&nbsp;> " + "<a class=bread_text>" + LocalResources.GetLabel("app_edit_harm_text") + "</a>";
