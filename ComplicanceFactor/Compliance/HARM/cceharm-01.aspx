<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="cceharm-01.aspx.cs" Inherits="ComplicanceFactor.Compliance.HARM.cceharm_01"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ValidationSummary CssClass="validation_summary_error" ID="vs_ccasharm" runat="server"
        ValidationGroup="cceharm" />
                ...
                $(".h_control_measure").click(function () {
                    ...
                    if (confirm("Do you want to delete this record?")) {
                        ...
                        $.ajax({
                            ...
                            url: "cceharm-01.aspx/DeleteControlmeasure",
    ...
    <div class="content_area_long">
        <div class="div_controls">
            <table class="div_table">
                <tr>
                    <td class="align_left">
                        <asp:Button ID="btnSave_header" ValidationGroup="cceharm" CssClass="cursor_hand"
                            Text="<%$ LabelResourceExpression: app_save_button_text %>" runat="server" OnClick="btnSave_header_Click" />
                    </td>
                    <td class="align_center">
                        <asp:Button ID="btnView_header" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_view_details_button_text %>" />
                    </td>
                    <td class="align_center">
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: left;">
                        <asp:UpdatePanel ID="upCaseNumber" runat="server">
                            <ContentTemplate>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCaseTitle" runat="server" ValidationGroup="cceharm"
                        ...
                        <asp:RegularExpressionValidator ID="retitle" runat="server" ErrorMessage="<%$ TextResourceExpression: app_size_limit_error_wrong%>"
                            ControlToValidate="txtCaseTitle" ValidationGroup="cceharm" ValidationExpression=".{0,20}">&nbsp;</asp:RegularExpressionValidator>
                        *
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="upCaseCategory" runat="server">
                            <ContentTemplate>
                    ...
                    <td>
                        <%--<asp:RequiredFieldValidator ID="rfvEmployeeReportLocation" runat="server" ValidationGroup="cceharm"
        ...
        <div class="hazard_control_measure">
            ...
            <asp:DataList ID="dlHazard" runat="server" CellPadding="0" CellSpacing="0" DataKeyField="h_hazard_id_pk"
                ...
                <%--   <ItemTemplate>
                    ...
                    <br />
                    <asp:GridView ID="gvControlMeasure" CellPadding="0" CellSpacing="0" ShowHeader="false"
                        ShowFooter="true" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvControlMeasure_RowDataBound"
                        OnRowCommand="gvControlMeasure_RowCommand" GridLines="none" DataKeyNames="h_hazard_id_fk,h_hazard_control_meausre_id_pk">
                        <Columns>
                            <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="td_hazard_control_measure">
                                                <asp:Label ID="lblControlMeasure" runat="server" Text='<%#Bind("h_control_measure_summary") %>'></asp:Label>
                                            </td>
                                            <td class="td_edit_hazard_control_measure">
                                                <asp:Button ID="btnEditControlMeasure" runat="server" Text="<%$ LabelResourceExpression: app_edit_button_text%>"
                                                    CommandName="EditControlMeasure" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                                            ...
                                            <td>
                                                <asp:Button ID="btnRemoveControlMeasure" OnClientClick="return ConfirmRemoveHazardControlMeasure();"
                                                    runat="server" Text="<%$ LabelResourceExpression: app_remove_button_text%>"
                                                    CommandName="RemoveControlMeasure" CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' />
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
            ...
            <asp:Button ID="btnAddHazard" OnClick="btnAddHazard_Click" CssClass='cursor_hand'
                runat="server" Text="<%$ LabelResourceExpression: app_add_hazard_button_text %>" />
        </div>
        <br />
        <div class="div_header_long">
                ...
                <ItemTemplate>
                    <fieldset>
                        ...
                        <asp:GridView ID="gvControlMeasureSummary" CellPadding="0" CellSpacing="0" GridLines="None"
                            ShowHeader="false" runat="server" CssClass="grid_900" ShowFooter="true" AutoGenerateColumns="False"
        ...
        <div class="div_padding_135">
            <asp:GridView ID="gvCustomForm" GridLines="None" CssClass="grid_table_850" CellPadding="0"
                CellSpacing="0" ShowHeader="false" ShowFooter="false" DataKeyNames="h_file_guid,h_file_name,h_custom_customer_form_id_pk"
        ...
        <div class="div_padding_135">
            <asp:GridView ID="gvPhoto" GridLines="None" CssClass="grid_table_850" CellPadding="0"
                CellSpacing="0" ShowHeader="false" ShowFooter="false" DataKeyNames="h_file_guid,h_file_name,h_photo_id_pk"
        ...
        <div class="div_padding_135">
            <asp:GridView ID="gvSceneSketch" GridLines="None" CssClass="grid_table_850" CellPadding="0"
                CellSpacing="0" ShowHeader="false" ShowFooter="false" DataKeyNames="h_file_guid,h_file_name,h_scene_sketch_id_pk"
        ...
        <div class="div_padding_135">
            <asp:GridView ID="gvExtenautingCondition" GridLines="None" CssClass="grid_table_850"
                CellPadding="0" CellSpacing="0" ShowHeader="false" ShowFooter="false" DataKeyNames="h_file_guid,h_file_name,h_extenauting_id_pk"
        ...
        <div class="div_padding_135">
            <asp:GridView ID="gvEmployeeInterview" GridLines="None" CssClass="grid_table_850"
                CellPadding="0" CellSpacing="0" ShowHeader="false" ShowFooter="false" DataKeyNames="h_file_guid,h_file_name,h_name,h_contact_info,h_employee_interivew_id_pk"
        ...
        <div class="div_controls">
            <table class="div_table">
                <tr>
                    ...
                    <td class="align_center">
                        <asp:Button ID="btnView_Footer" CssClass="cursor_hand" runat="server" Text="<%$ LabelResourceExpression: app_view_details_button_text %>" />
                    </td>
                    <td class="align_center">
                ...
                <div>
                    ...
                    <div class="uploadpanel">
                        <asp:ValidationSummary class="validation_summary_error_popup" ID="vsFileUpload" runat="server"
                            ValidationGroup="cceharmfileupload" />
                        <asp:CustomValidator ValidationGroup="cceharmfileupload" ID="cvFileUpload" runat="server"
                        ...
                        <div class="multiple_button">
                            <asp:Button ID="btnUploadCustomCustomer" ValidationGroup="cceharmfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text%>" CssClass="spinner cursor_hand"
                                OnClick="btnUploadCustomCustomer_Click" />
                            <asp:Button ID="btnUploadPhoto" ValidationGroup="cceharmfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text%>" CssClass="spinner cursor_hand"
                                OnClick="btnUploadPhoto_Click" />
                            <asp:Button ID="btnUploadSceneSketch" ValidationGroup="cceharmfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text%>" CssClass="spinner cursor_hand"
                                OnClick="btnUploadSceneSketch_Click" />
                            <asp:Button ID="btnUploadExtenautingcond" ValidationGroup="cceharmfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text%>" CssClass="spinner cursor_hand"
                                OnClick="btnUploadExtenautingcond_Click" />
                            <asp:Button ID="btnUploadEmployeeInterview" ValidationGroup="cceharmfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text%>" CssClass="spinner cursor_hand"
            ...
            <asp:Panel ID="pnlJobTitle" runat="server" CssClass="modalPopup_width_620 modal_popup_background" Style="display: none;
                ...
                <div>
                    <table cellpadding="0" cellspacing="0" class="button_600">
                        <tr>
                            <td>
                                <asp:Button ID="btnSaveJobTitle" OnClick="btnSaveJobTitle_Click" ValidationGroup="JobTitle"
        ...
        <div>
            ...
            <asp:Panel ID="pnlHazard" runat="server" CssClass="modalPopup_width_700 modal_popup_background" Style="display: none;
                        ...
                        <ContentTemplate>
                            ...
                            <div style="padding: 0 0 0 70px;">
                                <asp:GridView ID="gvNewControlMeasure" RowStyle-CssClass="record" ShowHeader="false"
                                    DataKeyNames="h_hazard_control_meausre_id_pk" GridLines="None" CellPadding="0"
                                    CellSpacing="0" runat="server" AutoGenerateColumns="false" OnRowCommand="gvNewControlMeasure_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="350px">
                                            <ItemTemplate>
                                                <%--<asp:RequiredFieldValidator ID="rfvHazard1" runat="server" ErrorMessage="Please enter the control measure"
                                                    ControlToValidate="txtAddControlMeasure" ValidationGroup="Hazard">&nbsp;</asp:RequiredFieldValidator>--%>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="35px">
                                            <ItemTemplate>
                                                <%--  <asp:Button ID="btnRemove" OnClientClick="return confirmremove();"  class="h_control_measure"
                                                    CommandArgument='<%# DataBinder.Eval(Container, "RowIndex") %>' runat="server"
                                                    Text="<%$ LabelResourceExpression: app_remove_button_text%>" CssClass="cursor_hand" />--%>
                ...
                <div style="padding: 0 10px 0 10px;">
                    <div class="left">
                        <asp:Button ID="btnSaveHazardControlMeausre" CausesValidation="true" ValidationGroup="Hazard"
                            runat="server" Text="<%$ LabelResourceExpression: app_save_button_text %>" OnClick="btnSaveHazardControlMeausre_Click" />
                    </div>
                    <div class="right">
                            ...
                            <asp:GridView ID="gvAddEditControlMeasure" RowStyle-CssClass="record" ShowHeader="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="350px">
                                        <ItemTemplate>
                                            <%-- <asp:RequiredFieldValidator ID="rfvHazard1" runat="server" ErrorMessage="Please enter the control measure"
                                                ControlToValidate="txtAddControlMeasure" ValidationGroup="ControlMeasure">&nbsp;</asp:RequiredFieldValidator>--%>
