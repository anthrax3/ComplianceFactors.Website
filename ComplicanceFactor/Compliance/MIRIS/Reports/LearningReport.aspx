<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LearningReport.aspx.cs"
    Inherits="ComplicanceFactor.Compliance.MIRIS.Reports.LearningReport" %>
...
<body>
    ...
    <div>
       ...
       <asp:ScriptManager ID="aa" runat="server"></asp:ScriptManager>
        <rsweb:ReportViewer ID="rvLearningReport" runat="server"  DocumentMapCollapsed="true" 
