<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="sastdrr-01.aspx.cs" Inherits="ComplicanceFactor.Compliance.MIRIS.Reports.popup.sastdrr_01" %>
    ...
    <div id="content">
        ...
        <div class="div_padding_25">
            <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                ...
                EmptyDataRowStyle-CssClass="empty_row" DataKeyNames="s_delivery_type_system_id_pk,s_delivery_type_id, s_delivery_type_name_us_english"
                PagerSettings-Visible="false" PageSize="5" OnPageIndexChanging="gvsearchDetails_PageIndexChanging">
                <Columns>
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_3" ItemStyle-CssClass="gridview_row_width_3"
                        HeaderText="Delivery Id" DataField='s_delivery_type_id' HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Left" />
                    <asp:BoundField HeaderStyle-CssClass="gridview_row_width_4" ItemStyle-CssClass="gridview_row_width_4"
                        HeaderText="Delivery Name" DataField='s_delivery_type_name_us_english' HeaderStyle-HorizontalAlign="Center"
                        ItemStyle-HorizontalAlign="Left" />
