<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true"
    CodeBehind="sasumsmr-01.aspx.cs" Inherits="ComplicanceFactor.Compliance.MIRIS.Popup.sasumsmr_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $("#<%=gvsearchDetails.ClientID %> input[name$='chkSelect']").attr('checked', false);
        $(o).attr('checked', true);   
                ...
                <asp:GridView ID="gvsearchDetails" CellPadding="0" CellSpacing="0" CssClass="table_700 tablesorter"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_1"
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="chkSelect" onclick="clearSelection(this);" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
