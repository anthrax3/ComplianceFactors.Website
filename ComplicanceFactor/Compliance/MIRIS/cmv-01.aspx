<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="cmv-01.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ComplicanceFactor.Compliance.MIRIS.cmv_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#<%=rblPublicVehicleInvolved.ClientID %>').click(function () {
                ...
                if (selected.value == 'Yes') {
                    document.getElementById('div_public_vehicle_info').style.display = "inline";
                }
                else {
                    document.getElementById('div_public_vehicle_info').style.display = "none";
                }
    ...
    <asp:ValidationSummary class="validation_summary_error" ID="vs_cmv" runat="server"
        ValidationGroup="cmv"></asp:ValidationSummary>
    ...
    <asp:CustomValidator ID="cvDOB" runat="server" ErrorMessage="<%$ TextResourceExpression: app_date_of_birth_error_empty %>"
        ForeColor="Red" ValidationGroup="cmv" ClientValidationFunction="validateDOB">&nbsp;</asp:CustomValidator>
    <asp:CustomValidator ID="cvHireDate" runat="server" ErrorMessage="<%$ TextResourceExpression: app_emp_hire_date_error_empty %>"
        ForeColor="Red" ValidationGroup="cmv" ClientValidationFunction="validateHireDate">&nbsp;</asp:CustomValidator>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" class="controls_long">
            <tr>
                <td align="left">
                    <asp:Button ID="btnSavenewcase_header" ValidationGroup="cmv" CssClass="cursor_hand"
                ...
                <td align="left">
                    <asp:Button ID="btnHeaderCompleteCase" OnClientClick="return ConfirmComplete();"
                        ...
                        ValidationGroup="cmv" CssClass="cursor_hand" OnClick="btnHeaderCompleteCase_Click" />
                </td>
                <td align="left">
                    <asp:Button ID="btnReset_Header" CssClass="cursor_hand" runat="server" OnClientClick="return ConfirmReset();" Text="<%$ LabelResourceExpression: app_reset_button_text %>"
    ...
    <div id="scrollDiv">
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCaseTitle" runat="server" ValidationGroup="cmv"
        ...
        <input type="hidden" id="scrollLeft" />
        ...
        <div class="div_controls font_1">
                                ...
                                <tr>
                                    ...
                                    <td class="align_left">
                                        &nbsp;<input type="checkbox" id="chkNonCollision" name="checkAddress" runat="server"
                                            onclick="checkAddress(this)" /><%--<asp:CheckBox ID="chkNonCollision" runat="server" />--%>
                                    </td>
                                    <td class="align_left">
            ...
            <div class="div_controls font_1 msg_display" id="div_casedetails" runat="server">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCollisionType" runat="server" CssClass="ddl_user_advanced_search">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCollisionDirection" runat="server" CssClass="ddl_user_advanced_search">
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlNonCollisionType" runat="server" CssClass="ddl_user_advanced_search">
                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
            ...
            <div id="div_public_vehicle_info" style="display: none;">
                <div class="div_header_long">
                ...
                <div class="div_controls font_1 msg_display" id="div_Public_vehicle" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPublicVehicleType" DataValueField=" " DataTextField=" "
                                    runat="server" CssClass="ddl_user_advanced_search">
                                    <asp:ListItem Text="Car" Value="Car"></asp:ListItem>
                                    <asp:ListItem Text="Lt Truck" Value="Lt Truck"></asp:ListItem>
                                    <asp:ListItem Text="CMV" Value="CMV"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="revBicycleAge" runat="server" ControlToValidate="txtBicycleAge"
                                ...
                                ValidationExpression="^\d+$" ValidationGroup="cmv">&nbsp;
                            </asp:RegularExpressionValidator>
                            <%=LocalResources.GetLabel("app_age_text")%>:
                        </td>
                        <td>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" class="controls_long">
            <tr>
                <td align="left">
                    <asp:Button ID="btnSaveNewCase_footer" ValidationGroup="cmv" CssClass="cursor_hand"
                        Text="<%$ LabelResourceExpression: app_save_new_case_button_text %>" runat="server"
                ...
                <td align="left">
                    <asp:Button ID="btnFooterCompleteCase" OnClientClick="return ConfirmComplete();"
                        runat="server" Text="<%$ LabelResourceExpression: app_complete_case_button_text %>"
                        ValidationGroup="cmv" CssClass="cursor_hand" OnClick="btnFooterCompleteCase_Click" />
                </td>
                <td align="left">
            ...
            <div>
                ...
                <div class="uploadpanel font_normal">
                    <asp:ValidationSummary class="validation_summary_error_popup" ID="vsFileUpload" runat="server"
                        ValidationGroup="cmvfileupload" />
                    <asp:CustomValidator ValidationGroup="cmvfileupload" ID="cvFileUpload" runat="server"
                    ...
                    <div class="multiple_button">
                        <asp:Button ID="btnUploadWitness" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                            OnClick="btnUploadWitness_Click" CssClass="cursor_hand" />
                        <asp:Button ID="btnUploadPhoto" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                            OnClick="btnUploadPhoto_Click" CssClass="cursor_hand" />
                        <asp:Button ID="btnUploadPolice" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                            OnClick="btnUploadPolice_Click" CssClass="cursor_hand" />
                        <asp:Button ID="btnUploadSceneSketch" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                            OnClick="btnUploadSceneSketch_Click" CssClass="cursor_hand" />
                        <asp:Button ID="btnUploadExtenautingcond" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                            OnClick="btnUploadExtenautingcond_Click" CssClass="cursor_hand" />
                        <asp:Button ID="btnUploadEmployeeInterview" ValidationGroup="cmvfileupload" Style="display: none;"
                            runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
