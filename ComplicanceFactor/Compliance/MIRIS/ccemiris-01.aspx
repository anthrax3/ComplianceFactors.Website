<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ccemiris-01.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ComplicanceFactor.Compliance.ccemiris_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ValidationSummary class="validation_summary_error" ID="vs_ccemiris" runat="server"
        ValidationGroup="ccemiris" />
    ...
    <asp:CustomValidator ID="cvDOB" runat="server" ErrorMessage="<%$ TextResourceExpression: app_date_of_birth_error_empty %>"
        ForeColor="Red" ValidationGroup="ccemiris" ClientValidationFunction="validateDOB">&nbsp;</asp:CustomValidator>
    <asp:CustomValidator ID="cvHireDate" runat="server" ErrorMessage="<%$ TextResourceExpression: app_emp_hire_date_error_empty %>"
        ForeColor="Red" ValidationGroup="ccemiris" ClientValidationFunction="validateHireDate">&nbsp;</asp:CustomValidator>
    ...
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="controls_long">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnSavecase_header" ValidationGroup="ccemiris" CssClass="cursor_hand"
                            Text="<%$ LabelResourceExpression:app_update_case_button_text  %>" runat="server"
                            OnClientClick="clearerror();" OnClick="btnSavecase_header_Click" />
                    </td>
                    <td align="center">
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCaseTitle" runat="server" ValidationGroup="ccemiris"
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeName" runat="server" ValidationGroup="ccemiris"
                ...
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeId" runat="server" ValidationGroup="ccemiris"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLastDigitofSSN" runat="server" ValidationGroup="ccemiris"
                ...
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvIncidentLocation" runat="server" ValidationGroup="ccemiris"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvUserIncidentDate" runat="server" ValidationGroup="ccemiris"
                            ControlToValidate="txtIncidentDate" ErrorMessage="<%$ TextResourceExpression: app_incident_date_error_empty %>">&nbsp;
                        </asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="revIncidentDate" runat="server" ValidationGroup="ccemiris"
                            ControlToValidate="txtIncidentDate" ErrorMessage="<%$ TextResourceExpression: app_incident_date_format_error_empty %>"
                            ValidationExpression="^\d{1,2}\/\d{1,2}\/\d{4}$">
                            &nbsp;</asp:RegularExpressionValidator>
                        <asp:CustomValidator ValidationGroup="ccemiris" ID="cvIncidentDate" runat="server"
                            ErrorMessage="Incident date can't be future date,Please select the valid date"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvIncidentTime" runat="server" ControlToValidate="IncidentTime"
                            ErrorMessage="<%$ TextResourceExpression: app_incident_time_error_empty %>" ValidationGroup="ccemiris">&nbsp;</asp:RequiredFieldValidator>
                        *
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="revDaysAwayFromWork" ControlToValidate="txtDaysAwayFromWork"
                            ...
                            ValidationGroup="ccemiris" ValidationExpression="\d+">&nbsp;</asp:RegularExpressionValidator>
                ...
                <tr>
                    <td>
                        <asp:RegularExpressionValidator ID="revDateOfDeath" runat="server" ValidationGroup="ccemiris"
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="controls_long">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnSaveCase_footer" ValidationGroup="ccemiris" CssClass="cursor_hand"
                            Text="<%$ LabelResourceExpression: app_update_case_button_text %>" runat="server"
                            OnClientClick="clearerror();" OnClick="btnSaveCase_footer_Click" />
                    </td>
                    <td align="center">
                    ...
                    <td align="left">
                        <asp:Button ID="btnResetFooter" runat="server" Text="<%$ LabelResourceExpression: app_reset_button_text %>"
                            OnClick="btnResetFooter_Click" CssClass="cursor_hand" OnClientClick="clearerror();" />
                    </td>
                    <td align="right">
                ...
                <div>
                    ...
                    <div class="uploadpanel font_normal">
                        <asp:ValidationSummary class="validation_summary_error_popup" ID="vsFileUpload" runat="server"
                            ValidationGroup="ccemirisfileupload" />
                        <asp:CustomValidator ValidationGroup="ccemirisfileupload" ID="cvFileUpload" runat="server"
                        ...
                        <div class="multiple_button">
                            <asp:Button ID="btnUploadWitness" ValidationGroup="ccemirisfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadWitness_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadPhoto" ValidationGroup="ccemirisfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadPhoto_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadPolice" ValidationGroup="ccemirisfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadPolice_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadSceneSketch" ValidationGroup="ccemirisfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadSceneSketch_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadExtenautingcond" ValidationGroup="ccemirisfileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadExtenautingcond_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadEmployeeInterview" ValidationGroup="ccemirisfileupload"
