<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ceoi-01.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ComplicanceFactor.Compliance.MIRIS.ceoi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ValidationSummary class="validation_summary_error" ID="vs_ceoi" runat="server"
        ValidationGroup="ceoi" />
    ...
    <asp:CustomValidator ID="cvDOB" runat="server" ErrorMessage="<%$ TextResourceExpression: app_date_of_birth_error_empty %>"
        ForeColor="Red" ValidationGroup="ceoi" ClientValidationFunction="validateDOB">&nbsp;</asp:CustomValidator>
    <asp:CustomValidator ID="cvHireDate" runat="server" ErrorMessage="<%$ TextResourceExpression: app_emp_hire_date_error_empty %>"
        ForeColor="Red" ValidationGroup="ceoi" ClientValidationFunction="validateHireDate">&nbsp;</asp:CustomValidator>
    <div class="content_area_long">
        <div>
            <table cellpadding="0" cellspacing="0" class="controls_long">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnSavecase_header" ValidationGroup="ceoi" CssClass="cursor_hand"
                    ...
                    <td align="center">
                        <asp:Button ID="btnHeaderCompleteCase" OnClientClick="return ConfirmComplete();"
                            ...
                            OnClick="btnHeaderCompleteCase_Click" ValidationGroup="ceoi" CssClass="cursor_hand" />
                    </td>
                    <td align="center">
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvCaseTitle" runat="server" ValidationGroup="ceoi"
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeName" runat="server" ValidationGroup="ceoi"
                    ...
                    <td>
                        <%--<asp:RequiredFieldValidator ID="rfvDateofBirth" runat="server" ValidationGroup="ceoi"
                            ControlToValidate="txtDateOfBirth" ErrorMessage="<%$ TextResourceExpression: app_date_of_birth_error_empty %>">&nbsp;
                        </asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="revDateOfBirth" runat="server" ValidationGroup="ceoi"
                            ControlToValidate="txtDateOfBirth" ErrorMessage="<%$ TextResourceExpression: app_date_of_birth_valid_error_empty %>"
                ...
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeId" runat="server" ValidationGroup="ceoi"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLastDigitofSSN" runat="server" ValidationGroup="ceoi"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revIncidentDate" runat="server" ValidationGroup="ceoi"
                            ControlToValidate="txtIncidentDate" ErrorMessage="<%$ TextResourceExpression: app_incident_date_format_error_empty %>"
                            ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$">
                            &nbsp;</asp:RegularExpressionValidator>
                        <asp:CustomValidator ValidationGroup="ceoi" ID="cvIncidentDate" runat="server" ErrorMessage="Incident date can't be future date,Please select the valid date"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvIncidentTime" runat="server" ControlToValidate="IncidentTime"
                            ErrorMessage="<%$ TextResourceExpression: app_incident_time_error_empty %>" ValidationGroup="ceoi">&nbsp;</asp:RequiredFieldValidator>
                        *
                ...
                <tr>
                    <td>
                        <asp:RegularExpressionValidator ID="revTimeDateNotified" runat="server" ValidationGroup="ceoi"
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlContributingFactors" DataTextField="" DataValueField=""
                            OnChange="ShowContributingFactors();" CssClass="ddl_user_advanced_search" runat="server">
        ...
        <div>
            <table cellpadding="0" cellspacing="0" class="controls_long">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnSaveCase_footer" ValidationGroup="ceoi" CssClass="cursor_hand"
                    ...
                    <td align="left">
                        <asp:Button ID="btnFooterCompleteCase" OnClientClick="return ConfirmComplete();"
                            runat="server" Text="<%$ LabelResourceExpression: app_complete_case_button_text %>"
                            OnClick="btnFooterCompleteCase_Click" ValidationGroup="ceoi" CssClass="cursor_hand" />
                    </td>
                    <td align="center">
                    ...
                    <td align="left">
                        <asp:Button ID="btnReset_Footer" CssClass="cursor_hand" OnClick="btnResetHeader_Click"
                            runat="server" Text="<%$ LabelResourceExpression: app_reset_button_text %>" />
                    </td>
                    <td align="right">
                ...
                <div>
                    ...
                    <div class="uploadpanel font_normal">
                        <asp:ValidationSummary class="validation_summary_error_popup" ID="vsFileUpload" runat="server"
                            ValidationGroup="ceoifileupload" />
                        <asp:CustomValidator ValidationGroup="ceoifileupload" ID="cvFileUpload" runat="server"
                        ...
                        <div class="multiple_button">
                            <asp:Button ID="btnUploadWitness" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadWitness_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadPhoto" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadPhoto_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadPolice" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadPolice_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadSceneSketch" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadSceneSketch_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadExtenautingcond" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
                                OnClick="btnUploadExtenautingcond_Click" CssClass="cursor_hand" />
                            <asp:Button ID="btnUploadEmployeeInterview" ValidationGroup="ceoifileupload" Style="display: none;"
                                runat="server" Text="<%$ LabelResourceExpression: app_upload_button_text %>"
