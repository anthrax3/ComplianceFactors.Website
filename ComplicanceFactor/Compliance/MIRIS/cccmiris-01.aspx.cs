...
namespace ComplicanceFactor.Compliance
{
    public partial class cccmiris_01 : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblBreadCrumb.Text = "<a href=/Compliance/cchp-01.aspx>" + LocalResources.GetGlobalLabel("app_nav_compliance") + "</a>&nbsp;" + " >&nbsp;" + "<a href=/Compliance/cchp-01.aspx>" + LocalResources.GetGlobalLabel("app_home_text") + "</a>&nbsp;" + " >&nbsp;" + LocalResources.GetLabel("app_miris_text");
            if (!IsPostBack)
            {
                try
                {
