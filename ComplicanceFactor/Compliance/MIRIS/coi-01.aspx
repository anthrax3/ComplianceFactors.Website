    ...
    <div class="content_area_long">
        ...
        <div class="div_controls font_1">
            <table>
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeName" runat="server" ValidationGroup="coi"
                ...
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeId" runat="server" ValidationGroup="coi"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvLastDigitofSSN" runat="server" ValidationGroup="coi"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revIncidentDate" runat="server" ValidationGroup="coi"
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvIncidentTime" runat="server" ControlToValidate="IncidentTime"
                            ErrorMessage="<%$ TextResourceExpression: app_incident_time_error_empty %>" ValidationGroup="coi">&nbsp;</asp:RequiredFieldValidator>
                        *
                ...
                <tr>
                    <td>
                        <asp:RequiredFieldValidator ID="rfvEmployeeReportLocation" runat="server" ValidationGroup="coi"
