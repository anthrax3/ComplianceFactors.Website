<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="ccppp.aspx.cs" Inherits="ComplicanceFactor.Compliance.ccppp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_comp_my_profile_text")%><br />
        <br />
        <br />
    </div>
            ...
            <table cellspacing="0" cellpadding="0" class="gridview_long_no_border">
                <thead>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlNumberOfRecordMyTodo" runat="server">
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlCollapsedMyTodo" DataValueField="id" DataTextField="name"
                                runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlNumberOfRecourdsHarm" runat="server">
                                <asp:ListItem Value="5">5</asp:ListItem>
                                <asp:ListItem Value="10">10</asp:ListItem>
                                <asp:ListItem Value="20">20</asp:ListItem>
                                <asp:ListItem Value="30">30</asp:ListItem>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlCollapsedHarm" DataValueField="id" DataTextField="name"
                                runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <%=LocalResources.GetLabel("app_my_giris_text")%>
                        </td>
                        <td align="center">
                            <asp:DropDownList ID="ddlNumberOfRecordsGiris" runat="server">
                                <asp:ListItem Value="5">5</asp:ListItem>
                                <asp:ListItem Value="10">10</asp:ListItem>
                                <asp:ListItem Value="20">20</asp:ListItem>
                                <asp:ListItem Value="30">30</asp:ListItem>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlCollapsedGiris" DataValueField="id" DataTextField="name"
                                runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
    ...
    <div class="content_area">
        <%= LocalResources.GetText("app_welcome_content_footer_comp_my_profile_text")%>
        <br />
        <br />
    </div>
    </div>
