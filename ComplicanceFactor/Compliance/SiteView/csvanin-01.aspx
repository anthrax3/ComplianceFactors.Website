<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="csvanin-01.aspx.cs" Inherits="ComplicanceFactor.Compliance.SiteView.csvanin_01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        $(document).ready(function () {
            ...
            $(".editQuestion").click(function () {
                ...
                $.fancybox({
                    ...
                    'overlayOpacity': 0.7,
                    'hideOnOverlayClick': false,
                    'href': 'Popup/csveq-01.aspx?mode=edit&page=csvanin' + "&id=" + record_id,
                    'onComplete': function () {
                        $('#fancybox-frame').load(function () {
                            $('#fancybox-content').height($(this).contents().find('body').height() + 20);
                            var heightPane = $(this).contents().find('#content').height();
            ...
            $(".deleteQuestion").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        url: "csvanin-01.aspx/DeleteQuestion",
    ...
    <div>
        <asp:ValidationSummary class="validation_summary_error" ID="vs_csvanin" runat="server"
            ValidationGroup="csvanin"></asp:ValidationSummary>
