<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="csvsojt.aspx.cs" Inherits="ComplicanceFactor.Compliance.SiteView.Ojt.Popup.csvsojt" %>
            ...
            $(".deleteUser").click(function () {
                ...
                if (confirm("Do you want to delete this record?")) {
                    ...
                    $.ajax({
                        ...
                        //csvsojt-01.aspx is the page name and delete instructor is the server side method to delete records in csvsojt-01.aspx.cs
                        url: "csvsojt.aspx/DeleteUser",
                ...
                <asp:GridView ID="gvNewUser" RowStyle-CssClass="record" ShowHeader="false" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" ItemStyle-Width="35px">
                            <ItemTemplate>
                                <input type="button" id='<%# Eval("sv_ojt_sent_to_id_pk") %>' value='<asp:Literal ID="Literal5" runat="server" Text="X" />'
