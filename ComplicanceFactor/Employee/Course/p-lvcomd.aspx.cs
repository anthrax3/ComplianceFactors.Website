...
{
    public partial class p_lvcomd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (!string.IsNullOrEmpty(Request.QueryString["eid"].ToString()))
                    {
                        userId = Request.QueryString["eid"].ToString();
                    }
        ...
        private void PopulateCourse(string courseId)
        {
            ...
            Enrollment completion = new Enrollment();
            completion= EnrollmentBLL.GetCompletionDetails(userId,courseId);
            lblCompletionDate.Text = completion.t_transcript_completion_date_time;
            lblCompletionStatus.Text = completion.t_transcript_passing_status_id_fk;
            lblScore.Text = completion.t_transcript_score;
