    ...
    <div class="content_area_long">
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:GridView ID="gvCourses" CellPadding="0" CellSpacing="0" CssClass="gridview_long_no_border tablesorter"
                                    runat="server" EmptyDataText="<%$ LabelResourceExpression: app_no_result_found_text %>" GridLines="None" DataKeyNames="c_curricula_path_course_id_fk"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_2"
                                            HeaderText="<%$ LabelResourceExpression: app_due_date_text %>" DataField='duedate' HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                                        <asp:BoundField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_2"
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="gridview_row_width_1" ItemStyle-CssClass="gridview_row_width_1"
                                            ...
                                            <ItemTemplate>
                                               ...
                                               <asp:Button ID="btnLaunch" runat="server" Text="<%$ LabelResourceExpression: app_launch_button_text %>" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "scormURL")%>'
        ...
        <div class="div_controls_from_left">
            <asp:GridView ID="gvRecertPath" RowStyle-CssClass="record" GridLines="None" CellPadding="0"
                CellSpacing="0" EmptyDataText="<%$ LabelResourceExpression: app_none_text %>" ShowHeader="false" ShowFooter="false" runat="server"
        ...
        <div class="div_controls_from_left">
            <asp:GridView ID="gvCurriculumAttachments" Width="530px" GridLines="None" CellPadding="0"
                ...
                runat="server" EmptyDataText="<%$ LabelResourceExpression: app_none_text %>" AutoGenerateColumns="False" OnRowCommand="gvCurriculumAttachments_RowCommand">
                <Columns>
        ...
        <div class="div_controls_from_left">
            ...
            <asp:GridView ID="gvPrerequisites" RowStyle-CssClass="record" GridLines="None" CssClass="gridview_width_95"
                CellPadding="0" CellSpacing="0" EmptyDataText="<%$ LabelResourceExpression: app_none_text %>" ShowHeader="false" ShowFooter="false"
