...
namespace ComplicanceFactor.Employee
{
    public partial class bchp_01 : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblBreadCrumb.Text = "<a href=/Employee/Home/lhp-01.aspx>" + LocalResources.GetGlobalLabel("app_nav_employee") + "</a>" + " > " + LocalResources.GetGlobalLabel("app_browse_catalog_text");
            //go button
