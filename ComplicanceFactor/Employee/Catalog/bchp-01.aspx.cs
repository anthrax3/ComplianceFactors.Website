...
{
    public partial class bchp_01 : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Label lblBreadCrumb = (Label)Master.FindControl("lblBreadCrumb");
            lblBreadCrumb.Text = "<a href=/Employee/Home/lhp-01.aspx>" + LocalResources.GetGlobalLabel("app_nav_employee") + "</a>" + " >&nbsp;" + "<a href=/Employee/Home/lhp-01.aspx>" + LocalResources.GetGlobalLabel("app_home_text") + "</a>" + " >&nbsp;" + "<a class=bread_text>" + LocalResources.GetGlobalLabel("app_browse_catalog_text") + "</a>"; 
            //go button
        ...
        protected void lstCatalogCategories_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
           ...
           // LinkButton lnkCategoryName = (LinkButton)e.Item.FindControl("lnkCategoryName");
            ...
            if (e.CommandName.Equals("MainCategory"))
            {
                ...
                Response.Redirect("~/Employee/Catalog/bcdp-01.aspx?id=" + SecurityCenter.EncryptText(e.CommandArgument.ToString()));
        ...
        protected void gvSubCategories_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("SubCategory"))
            {
                ...
                Response.Redirect("~/Employee/Catalog/bcdp-01.aspx?id=" + SecurityCenter.EncryptText(subCategoryId)+ "&pid=" + SecurityCenter.EncryptText(parentCategoryId));
