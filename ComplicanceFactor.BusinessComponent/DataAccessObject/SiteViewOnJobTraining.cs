...
namespace ComplicanceFactor.BusinessComponent.DataAccessObject
{
    public class SiteViewOnJobTraining
    {
        ...
        public string sv_ojt_certify_filename { get; set; }
        public string sv_ojt_certify_fileExt { get; set; }
        public bool sv_ojt_certify_file_isUpdate { get; set; }
        public bool sv_ojt_certify_file_Update_sync { get; set; }

        public string sv_ojt_created_by { get; set; }
