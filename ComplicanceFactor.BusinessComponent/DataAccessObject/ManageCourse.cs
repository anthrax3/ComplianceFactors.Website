...
namespace ComplicanceFactor.BusinessComponent.DataAccessObject
{
    public class ManageCourse
    {
        ...
        public string s_course_locale_system_id_pk { get; set; }
        public string s_course_locale_name { get; set; }
        public string s_course_locale_description { get; set; }
        public string s_course_locale_abstract { get; set; }
        public string s_locale_text { get; set; }
        public string s_locale_id_fk { get; set; }
        public string s_course_system_id_fk { get; set; }
        //delivery locale
        public string s_delivery_system_id_fk { get; set; }
        public string s_delivery_locale_name { get; set; }
        public string s_delivery_locale_description { get; set; }
        public string s_delivery_locale_abstract { get; set; }
        public string s_delivery_aicc_url { get; set; }
        public string s_delivery_scorm_url { get; set; }
        public string s_delivery_locale_system_id_pk { get; set; }
